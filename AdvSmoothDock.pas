...
const
  ...
  //v1.4.0.2 : Fixed : OnItemDragDelete only triggered when real item delete is about to happen
  //v1.4.0.3 : Fixed : Issue with selected itemindex not supporting -1
  //v1.4.1.0 : New : Per monitor support for high DPI and Fix for seperator orientation
...
begin
  ...
  begin
    ...
    if Assigned(FOnItemDragDelete) and not IsMove then
