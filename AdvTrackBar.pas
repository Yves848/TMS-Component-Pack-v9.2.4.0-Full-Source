...
const
  ...
  // v1.6.9.3 : Fixed : Issue with OnChanged event handler
  // v1.6.9.4 : Improved : Painting of right thumb of TAdvRangeSlider
  // v1.6.10.0 : Improved : Support for High DPI for TAdvRangeSlider
  // v1.6.10.1 : Fixed : Issue with setting Office styles & separate thumb left & right size
  // v1.6.10.2 : Improved : Support for High DPI for TAdvTrackBar
  //                        TAdvRangeSlider Slider background behaviour with pictures on High DPI
...
type
  ...
  public
    ...
    procedure AssignColors(Source: TPersistent); virtual;
  published
...
procedure TextSize(Canvas: TCanvas; f: TFont; Text: string; var h, w: Integer; ADPIScale: single = 1);
var
  OldF: TFont;
begin
  OldF := TFont.Create;
  ...
  Canvas.Font.Size := Round(ADPIScale * f.Size);
...
begin
  ...
  begin
    Result.Top := Result.Top + Round(Slider.Offset * FDPIScale);
  ...
  begin
    Result.Left := Result.Left + Round(Slider.Offset * FDPIScale);
    if (FTrackLabel.Visible and (FTrackLabel.Position in [lpTopCenter, lpTopLeft, lpTopRight])) then
  ...
  begin
    if (FOrientation = trHorizontal) then
    begin
      Result.Left := MinButtonRect.Right + Round(Buttons.Spacing * FDPIScale);
      Result.Right := MaxButtonRect.Left - Round(Buttons.Spacing * FDPIScale);
    end
    else // (FOrientation = trVertical)
    begin
      Result.Bottom := MinButtonRect.Top - Round(Buttons.Spacing * FDPIScale);
      Result.Top := MaxButtonRect.Bottom + Round(Buttons.Spacing * FDPIScale);
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        L := Round(FDPIScale * TickMark.Size);
        {DefaultDraw := True;
        if TickMark.ShowImageAtThumbOnly then
...
begin
  ...
  if (FOrientation = trHorizontal) then
  begin
    i := i + Round(FDPIScale * TickMark.Size);
...
begin
  ...
  begin
    ...
    begin
      ...
      Result := Rect(R.Left + j, R2.Bottom + Round(FDPIScale * TickMark.Spacing), R.Right - j, R2.Bottom + Round(FDPIScale * TickMark.Spacing) + i);
    end
    else if (FTickMark.Style <> tsNone) and (FTickMark.Position in [tmTopLeft, tmBoth]) then
    begin
      R2 := TickMarkTopRect;
      Result := Rect(R.Left + j, R2.Bottom + Round(FDPIScale * TickMark.Spacing * 2), R.Right - j, R2.Bottom + Round(FDPIScale * TickMark.Spacing * 2) + i);
    end
    else
    begin
      R2 := TrackClientRect;
  ...
  begin
    ...
    begin
      ...
      Result := Rect(R2.Right + Round(FDPIScale * TickMark.Spacing), R.Top + j, R2.Right + Round(FDPIScale * TickMark.Spacing) + i, R.Bottom - j);
    end
    else if (FTickMark.Style <> tsNone) and (FTickMark.Position in [tmTopLeft, tmBoth]) then
    begin
      R2 := TickMarkTopRect;
      Result := Rect(R2.Right + Round(FDPIScale * TickMark.Spacing * 2), R.Top + j, R2.Right + Round(FDPIScale * TickMark.Spacing * 2) + i, R.Bottom - j);
    end
    else
    begin
      R2 := TrackClientRect;
...
begin
  ...
  begin
    if (FTickMark.Style <> tsNone) and (FTickMark.Position in [tmTopLeft, tmBoth]) then
      Result.Top := TickMarkTopRect.Bottom + Round(DPIScale * TickMark.Spacing)
    else
      Result.Top := R.Top;

    Result.Bottom := Result.Top + Round(FDPIScale * Slider.Size);
  end
  else // (FOrientation = trVertical)
  begin
    if (FTickMark.Style <> tsNone) and (FTickMark.Position in [tmTopLeft, tmBoth]) then
      Result.Left := TickMarkTopRect.Right + Round(FDPIScale * TickMark.Spacing)
    else
      Result.Left := R.Left;
    Result.Right := Result.Left + Round(FDPIScale * Slider.Size);
  end;
end;

//------------------------------------------------------------------------------

procedure TCustomTrackBar.CalcTextHeight;
var
  w: integer;
begin
  TextSize(Canvas, FTickMark.Font, 'gh', FTextHeight, w, FDPIScale);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        R2 := TickMarkTopRect;
        Result.Top := R2.Top + Round(FDPIScale * TickMark.Spacing) - (GetThumbSize div 2);
        Result.Bottom := Result.Top + GetThumbSize;
      end
      else
      begin
  ...
  begin
    ...
    begin
      ...
      begin
        R2 := TickMarkTopRect;
        Result.Left := R2.Left + Round(FDPIScale * TickMark.Spacing) - (GetThumbSize div 2);
        Result.Right := Result.Left + GetThumbSize;
      end
      else
      begin
...
begin
  ...
  begin
    gap := Round(FDPIScale * FTrackLabel.Spacing);
    Oldf := TFont.Create;
    Oldf.Assign(Canvas.Font);
    Canvas.Font.Assign(FTrackLabel.Font);
    Canvas.Font.Height := Round(FDPIScale * FTrackLabel.Font.Height);
...
begin
  ...
  begin
    if BackGroundStretched or (FDPIScale > 1) then
    begin
      Pic.GetImageSizes;
      bmp := TBitmap.Create;
      try
...
begin
  ...
  begin
    ...
    begin
      ...
      if (Slider.PictureStretched) or (FDPIScale > 1) then
      begin
        bmp := TBitmap.Create;
        try
          bmp.Width := Width;
          bmp.Height := Round(PicCM.Height * FDPIScale);
          bmp.Transparent := true;
          bmp.Canvas.StretchDraw(Rect(0, 0, R.Right - R.Left, Round(picCM.Height * FDPIScale)), PicCM);
    ...
    begin
      ...
      try
        bmp.Width := Width;
        bmp.Height := Round(Pic.Height * FDPIScale);
        bmp.Transparent := true;
        bmp.Canvas.StretchDraw(Rect(0, 0, R.Right - R.Left, Round(pic.Height * FDPIScale)), pic);
        Canvas.Draw(R.Left, R2.Top, bmp);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            TextSize(Canvas, TickMark.Font, S, h, w, FDPIScale);
            PTxt.X := PTxt.X - (W div 2);

            Canvas.Font.Assign(TickMark.Font);
            Canvas.Font.Size := Round(FDPIScale * TickMark.Font.Size);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              PTxt := Point(Rb.Left + Round(FDPIScale * TickMark.Size) + FTickTextOffset, Rt.Bottom - p.X);
              PTxt.Y := PTxt.Y - (FTextHeight div 2);
            end;
...
begin
  ...
  R := TrackLabelRect;
  Canvas.Font.Assign(FTrackLabel.Font);
  Canvas.Font.Size := Round(FTrackLabel.Font.Size * FDPIScale);
...
begin
  ...
  begin
    ...
    Pic.Transparent := True;
    if FDPIScale > 1 then
      Canvas.StretchDraw(Rect(R.Left, R.Top, R.Left +  Round(pic.Width * FDPIScale), R.Top + Round(pic.Height * FDPIScale)), pic)
    else
      Canvas.Draw(R.Left, R.Top, Pic);
  end
  else
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if (Pic.Height > Round(FDPIScale * Buttons.Size)) then
    ...
    begin
      ...
      case (Buttons.Shape) of
        ...
        begin
          if (Orientation = trHorizontal) then
          begin
            h := R.Top + ((R.Bottom - R.Top) - Round(FDPIScale * Buttons.Size)) div 2;
            R2 := Rect(R.Left, h, Round(DPIScale * Buttons.Size), Round(FDPIScale * Buttons.Size));
            R3 := Rect(R.Left, h, R.Right, h + Round(FDPIScale * Buttons.Size));
          end
          else // (Orientation = trVertical
          begin
            h := R.Left + ((R.Right - R.Left) - Round(FDPIScale * Buttons.Size)) div 2;
            R2 := Rect(h, R.Top, Round(FDPIScale * Buttons.Size), Round(FDPIScale * Buttons.Size));
            R3 := Rect(h, R.Top, h + Round(FDPIScale * Buttons.Size), R.Bottom);
          end;

          path := CreateRoundRectangle(R2, Round(FDPIScale * Buttons.Size) div 2);
          Rgn := TGPRegion.Create(path);
          graphic.SetClip(Rgn);
          path.Free;
        ...
        begin
          if (Orientation = trHorizontal) then
          begin
            R2 := Rect(R.Left, R.Top, Round(FDPIScale * Buttons.Size), Round(FDPIScale * Buttons.Size));
      ...
      begin
        ...
        h := h + (h mod 2);
        h := Round(FDPIScale * h);
        R4.Left := R3.Left - 1 + (Round(FDPIScale * Buttons.Size) - h) div 2;
        ...
        Canvas.LineTo(R4.Right - 1, R4.Top + 2);
          { | }
        R4.Left := R3.Left + 1 + (Round(FDPIScale * Buttons.Size) - 4) div 2;
        R4.Right := R4.Left + 3;
    ...
    begin
      ...
      case (Buttons.Shape) of
        ...
        begin
          ...
          begin
            h := R.Top + ((R.Bottom - R.Top) - Round(FDPIScale * Buttons.Size)) div 2;
            R2 := Rect(R.Left, h, Round(FDPIScale * Buttons.Size), Round(FDPIScale * Buttons.Size));
            R3 := Rect(R.Left, h, R.Right, h + Round(FDPIScale * Buttons.Size));
          end
          else // (Orientation = trVertical
          begin
      ...
      begin
        ...
        R4.Right := R4.Left + 4;
        R4.Top := R3.Top - 1 + (Round(FDPIScale * Buttons.Size) - h) div 2;
...
begin
  Result := InternalClientRect;
  if (FOrientation = trHorizontal) then
    Result.Left := Result.Right - Round(FDPIScale * ButtonWidth)
  else // (FOrientation = trVertical)
    Result.Bottom := Result.Top + Round(FDPIScale * ButtonWidth);
end;
...
begin
  Result := InternalClientRect;
  if (FOrientation = trHorizontal) then
    Result.Right := Result.Left + Round(FDPIScale * ButtonWidth)
  else // (FOrientation = trVertical)
    Result.Top := Result.Bottom - Round(FDPIScale * ButtonWidth);
end;
...
procedure TCustomTrackBar.CreateWnd;
begin
  inherited;
  FDPIScale := GetDPIScale(Self, Canvas);
end;
...
procedure TTrackBarThumb.AssignColors(Source: TPersistent);
begin
  if (Source is TTrackBarThumb) then
  begin
    FBorderColor := (Source as TTrackBarThumb).BorderColor;
...
begin
  Result := Round(ThumbRight.Size * FDPIScale);
end;
...
begin
  ...
  ThumbRight.AssignColors(ThumbLeft);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        R2 := TickMarkTopRect;
        Result.Top := R2.Top + Round(FDPIScale * TickMark.Spacing) - (GetThumbRightSize div 2);
        Result.Bottom := Result.Top + GetThumbRightSize;
      end
      else
      begin
  ...
  begin
    ...
    begin
      ...
      begin
        R2 := TickMarkTopRect;
        Result.Left := R2.Left + Round(FDPIScale * TickMark.Spacing) - (GetThumbRightSize div 2);
        Result.Right := Result.Left + GetThumbRightSize;
      end
      else
      begin
...
begin
  Result := Round(FDPIScale * ThumbLeft.Width);
(*
  ...
  begin
    ...
    begin
      ...
      begin
        bmp := TBitmap.Create;
        try
          bmp.Width := Round(FDPIScale * Pic.Width);
          bmp.Height := Round(FDPIScale * Pic.Height);
          bmp.Transparent := true;
      ...
      begin
        ...
        begin
          ...
          try
            ...
            bmp.Height := Round(FDPIScale * Pic.Height);
            bmp.Transparent := true;
            bmp.Canvas.StretchDraw(Rect(0, 0, bmp.Width, bmp.Height), PicCM);
            Canvas.Draw(R.Left, R.Top, bmp);
          finally
            bmp.Free;
          end;
      ...
      begin
        ...
        begin
          ...
          try
            ...
            bmp.Height := Round(FDPIScale * Pic.Height);
            bmp.Transparent := true;
            bmp.Canvas.StretchDraw(Rect(0, 0, bmp.Width, bmp.Height), PicRM);
            Canvas.Draw(R.Left, R.Top, bmp);
          finally
            bmp.Free;
          end;
