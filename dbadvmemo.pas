...
type
  ...
  protected
    procedure DoSetText(Sender: TObject); virtual;
...
procedure TDBAdvMemo.LinesChanged(Sender: TObject);
begin
  inherited;
end;
...
procedure TDBAdvMemo.DoSetText(Sender: TObject);
begin
  EditCanModify;
end;
