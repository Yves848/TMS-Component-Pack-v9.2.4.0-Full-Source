...
type
  ...
  protected
    procedure SetOfficeTabSetStyle(const Value: TOfficeTabSetStyle); virtual;
    procedure SetOfficeTabSetStyleAndAppColor(const Value: TOfficeTabSetStyle; AppColor: TColor); virtual;
