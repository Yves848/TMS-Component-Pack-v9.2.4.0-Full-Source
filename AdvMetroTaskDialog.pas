...
const
  ...
  // 1.0.1.0 : Improved : Adaptions for per monitor high DPI
...
begin
  ...
  Canvas.Font.Size := Round(10 * LScale);
    ...
    begin
      ...
      begin
        ...
        Windows.DrawText( Canvas.Handle,
          ...
          DrawTextBiDiModeFlagsReadingOnly);
        with TextRect do
          ButtonWidths[B] := Right - Left + Round(16 * LScale);
      end;
      ...
      begin
        ...
        Width := Max(Round(60 * LScale), ButtonWidths[B]);
        Height := ButtonHeight;
...
//        OnClick := OnButtonClick;
  ...
  begin
    ...
    begin
      ...
      if not (doCommandLinksNoIcon in TaskDialog.Options) then
        w := Max(w, n + FHorzMargin*2 + FHorzSpacing + Round(32 * LScale))
      else
      ...
      begin
        ...
        Width := Max(Round(60 * LScale), n);
        if TaskDialog.DefaultButton <> -1 then
          AutoFocus := true;

        Height := Max(bh, Max(ButtonHeight, Canvas.TextHeight('gh') + Round(20 * LScale)));
  ...
  begin
    ...
    Windows.DrawText( canvas.handle,
      ...
      TextRect, DT_CALCRECT or DT_LEFT or DT_SINGLELINE or
      DrawTextBiDiModeFlagsReadingOnly);
    with TextRect do ButtonWidths[B] := Right - Left + Round(8 * LScale);
  ...
  Canvas.Font.Size := Round(11 * LScale);
  ...
  if IconID <> '' then
  begin
    Inc(IconTextWidth, Round(32 * LScale) + FHorzSpacing);
    if IconTextHeight < Round(32 * LScale) then IconTextHeight := Round(32 * LScale);
  end;
  ...
  begin
    ...
    begin
      ...
      SetBounds(FHorzMargin, Y, Round(48 * LScale), Round(48 * LScale));
    end;
  end;
  ...
  begin
    ...
    begin
      Name := 'ProgressBar';
      Parent := Self;
      BoundsRect := Rect(FHorzMargin, Y, Width - FHorzMargin, Y + Round(12 * LScale));
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Width := Self.Width - Left - 4;
        GetTextSize(Canvas, Caption, k, l);
        w := Max(w, Left + k + FHorzMargin + Round(20 * LScale));
      end;
  ...
  begin
    FExpTextXSize := 0;
    FExpTextYSize := 0;
    r := Rect(FHorzMargin, Y, 300, Y + Round(26 * LScale));
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Parent := Self;
        Visible := False;
        SetBounds(FHorzMargin, Y, Round(16* LScale), Round(16* LScale));
      end;
    end;
  end;
  ...
  itEdit:
    begin
      ...
      FInputEdit.SetBounds(ALeft, Y + Round(20 * LScale), ClientWidth - ALeft, Round(20*LScale));
    end;
  itComboEdit, itComboList:
    begin
      ...
      FInputCombo.SetBounds(ALeft, Y + Round(20*LScale), ClientWidth - ALeft, Round(20*LScale));
    end;
  itDate:
    begin
      ...
      FInputDate.Top := Y + Round(20*LScale);
  ...
  itMemo:
    begin
      ...
      if UseRightToLeftAlignment then
        ALeft := Self.ClientWidth - ALeft - Width;
      FInputMemo.SetBounds(ALeft, Y + Round(20*LScale), ClientWidth - ALeft, Round(60*LScale));
    end;
  itCustom:
    begin
      ...
      begin
        ...
        TaskDialog.InputControl.Top := Y + Round(20*LScale);
...
begin
  ...
  begin
    ...
    Y1 := 0;
    r := GetContentRect;
    r := Rect(r.Left, Y, R.Right, Y + Round(26* LScale));
...
begin
  ...
  begin
    ...
    Result := Rect(X, Y, ClientWidth - FHorzMargin, Y + Round(FContentYSize * LScale));
  end;
end;
...
begin
  ...
  i := Round(FWhiteWindowHeight * LScale);
