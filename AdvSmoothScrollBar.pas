...
type
  ...
  TAdvSmoothScrollBarMouseDown = procedure(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer) of object; //PM

  TAdvSmoothScrollBarMouseMove = procedure(Sender: TObject; Shift: TShiftState; X, Y: Integer) of object; //PM
    ...
    FTMSStyle: TTMSStyle;
  {
    ...
    FOnMouseDown : TAdvSmoothScrollBarMouseDown;
    FOnMouseMove : TAdvSmoothScrollBarMouseMove;
...
//    property AnimationFactor: integer read FAnimationFactor write SetAnimationFactor default 4;
    ...
    property OnMouseMove: TAdvSmoothScrollBarMouseMove read FOnMouseMove write FOnMouseMove;
    property OnMouseDown: TAdvSmoothScrollBarMouseDown read FOnMouseDown write FOnMouseDown;
    property Align;
    property Anchors;
    property BiDiMode;
...
begin
  ...
  r := InsideRect;
  case Kind of
    sbHorizontal: Result := MakeRect(r.Right - Appearance.ScrollButtonSize * DPIScale, r.Top, Appearance.ScrollButtonSize * DPIScale, r.Bottom - r.Top);
    sbVertical: Result := MakeRect(r.Left, r.Bottom - Appearance.ScrollButtonSize * DPIScale, r.Right - r.Left, Appearance.ScrollButtonSize * DPIScale);
  end;
end;
...
begin
  ...
  case Kind of
    sbHorizontal: Result := MakeRect(r.X + r.Width - Appearance.GetThumbButtonSize * DPIScale, r.Y, Appearance.GetThumbButtonSize * DPIScale, r.Height);
    sbVertical: Result := MakeRect(r.X, r.Y + r.Height - Appearance.GetThumbButtonSize * DPIScale, r.Width, Appearance.GetThumbButtonSize * DPIScale);
  end;
end;
...
begin
  ...
  r := InsideRect;
  case Kind of
    sbHorizontal: Result := MakeRect(r.Left, r.Top, Appearance.ScrollButtonSize * DPIScale, r.Bottom - r.Top);
    sbVertical: Result := MakeRect(r.Left, r.Top, r.Right - r.Left, Appearance.ScrollButtonSize * DPIScale);
  end;
end;
...
begin
  ...
  case Kind of
    sbHorizontal: Result := MakeRect(r.X, r.Y, Appearance.GetThumbButtonSize* DPIScale, r.Height);
    sbVertical: Result := MakeRect(r.X, r.Y, r.Width, Appearance.GetThumbButtonSize* DPIScale);
  end;
end;
