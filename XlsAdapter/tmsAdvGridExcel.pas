...
begin
  ...
  try
    ...
    begin
      ...
      if FOptions.ImportCellSizes then
        CurrentGrid.RowHeights[rg] := Round(Workbook.RowHeight[r] / RowMult * Zoom100 * CurrentGrid.DPIScale) + CellOfs + CurrentGrid.XYOffset.Y;
    ...
    begin
      ...
      if FOptions.ImportCellSizes then
        CurrentGrid.ColWidths[cg] := Round(Workbook.ColumnWidth[c] / ColMult * Zoom100 * CurrentGrid.DPIScale) + CellOfs + CurrentGrid.XYOffset.X;
    end;
...
begin
  ...
  if cg + Span > Length(LastRowBorders) - 1 then
    Span := Length(LastRowBorders) - 1 - cg;
      ...
      begin
        ...
        begin
         ...
         if Options.ExportHiddenColumns then
          ...
          begin
            LastCellRow := rx + cp.CellSpanY;
            LastCellCol := cx + cp.CellSpanX;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        AdvStringGrid := AOwner.Components[i] as TAdvStringGrid;
        Break;
      end;
    end;
  end;
