...
{$IFDEF TMSPACK}
  , AdvOfficeSelectors, AdvOfficeComboBox, AdvBadge
{$ENDIF}
...
{$IFDEF TMSPACK}
  ...
  ABadgeGlowButton: TAdvBadgeGlowButton;
{$ENDIF}
...
begin
  ...
  24:
    begin
      ABadgeGlowButton := TAdvBadgeGlowButton(Designer.CreateComponent(TAdvBadgeGlowButton,Component,0, 0,23,22));
      ABadgeGlowButton.Width := 23;
      ABadgeGlowButton.Height := 22;
      ABadgeGlowButton.Parent := ATB;
      ABadgeGlowButton.FocusType := ftHot;
      if Assigned(ATB.Images) then
        ABadgeGlowButton.Images := TImageList(ATB.Images);
      if Assigned(ATB.DisabledImages) then
        ABadgeGlowButton.DisabledImages := TImageList(ATB.DisabledImages);
      ABadgeGlowButton.Caption := '';
      if Assigned(ATB.ToolBarStyler) then
        ABadgeGlowButton.Appearance.Assign(ATB.ToolBarStyler.GlowButtonAppearance);
    end;
...
begin
  ...
  24: Result := 'Add AdvBadgeGlowButton';
  {$ENDIF}
  end;
end;
...
begin
  ...
  24:
    begin
      ...
      begin
        ABadgeGlowButton.FocusType := ftHot;
        ABadgeGlowButton.Width := 22;
        ABadgeGlowButton.Height := 20;
        ABadgeGlowButton.Transparent := True;
        ABadgeGlowButton.Left := 1000;
        if Assigned(TAdvQuickAccessToolBar(ATB).Images) then
          ABadgeGlowButton.Images := TImageList(TAdvQuickAccessToolBar(ATB).Images);
        if Assigned(TAdvQuickAccessToolBar(ATB).DisabledImages) then
          ABadgeGlowButton.DisabledImages := TImageList(TAdvQuickAccessToolBar(ATB).DisabledImages);
        if (TAdvQuickAccessToolBar(ATB).Parent is TAdvToolBarPager) and Assigned(TAdvToolBarPager(ATB.Parent).ToolBarStyler) then
          ABadgeGlowButton.Appearance.Assign(TAdvToolBarPager(ATB.Parent).ToolBarStyler.GlowButtonAppearance);
      end;
    end;
...
begin
  ...
  23:
    begin
      ...
      ABadgeGlowButton.Width := 23;
      ABadgeGlowButton.Height := 22;
      ABadgeGlowButton.Parent := TAdvToolBarContainer(Component);
      ABadgeGlowButton.Caption := '';
    end;
  {$ENDIF}
  end;
...
begin
  ...
  23: Result := 'Add AdvBadgeGlowButton';
  {$ENDIF}
  end;
end;
...
begin
  ...
  5:begin
      ShowMessage('TMS Advanced ToolBars & Menus version ' + TAdvToolBarPager(Component).Version+#13#10'Copyright © 2005 - 2017 by TMS software');
    end;
  end;
end;
