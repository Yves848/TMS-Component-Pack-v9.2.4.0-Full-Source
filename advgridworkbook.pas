...
const
  ...
  BLD_VER = 1; // Build nr.
  DATE_VER = 'Jul, 2017'; // Month version
  ...
  // 3.3.3.0 : Improved : Persisted grid print settings when changing active tab
  // 3.3.3.1 : Fixed : Issue with ThousandSeparator handling
...
begin
  ...
  FSheets[FActiveSheet].PrintSettings.Assign(FGrid.PrintSettings);
...
begin
  ...
  begin
    ...
    begin
      ...
      FGrid.PrintSettings.Assign(FSheets[Value].PrintSettings);
    end
    else
    begin
      FGrid.Clear;
...
begin
  ...
  FPrintSettings := TPrintSettings.Create(nil);
