...
begin
  ...
  0:begin
      {$I COMPILERTEXT.INC}
      MessageDlg(Component.ClassName+' version '+(Component as TAdvStringGrid).VersionString+' for '+compiler+#13#10'© 1997-2019 by TMS software', mtinformation,[mbok],0);
    end;
  1:begin
      ShellExecute(0,'open','https://www.tmssoftware.com',nil,nil,SW_NORMAL);
    end;
  2:begin
  ...
  10:
    begin
      ShellExecute(0, 'open', 'http://www.tmssoftware.biz/download/manuals/TMS%20TAdvStringGrid%20Developers%20Guide.pdf', nil, nil, SW_SHOW);
    end;
  11:
    begin
      ShellExecute(0, 'open', 'http://www.tmssoftware.com/site/advgrid.asp?s=faq', nil, nil, SW_SHOW);
    end;
  end;
end;
