...
const
  ...
  // 1.5.1.0 : New : Event OnAnchorClick added
  // 1.5.2.0 : New : Support for showing handpoint cursor over hyperlinks added
...
type
  ...
  TMsgAnchorClickEvent = procedure(Sender: TObject; Index: integer; Anchor: string; var Cancel: boolean) of object;
  ...
  private
    ...
    FProgClose: boolean;
    FOnAnchorClick: TMsgAnchorClickEvent;
  ...
  published
    ...
    property OnAnchorClick: TMsgAnchorClickEvent read FOnAnchorClick write FOnAnchorClick;
...
begin
  ...
  HTMLDrawEx(Canvas, Msg.Text, R, FImages, 0, 0, -1, FHoverLink, 1, False, True, False, False, True, False{FHover}, True, True,
...
procedure TAdvSmartMessageForm.MouseDown(Button: TMouseButton;
...
begin
  ...
  begin
    ...
    if HTMLDrawEx(Canvas, FSmartMsg.Text, TextR, FAdvSmartMessageBox.FImages, X, Y, -1, FAdvSmartMessageBox.FHoverLink, 1, True, False, False, False, True, False, True, True,
      1.0, clBlue, clNone, clNone, clGray, Anchor, Stripped, FocusAnchor, XSize, YSize,
      HyperLinks, MouseLink, hr, FAdvSmartMessageBox.FImageCache, FAdvSmartMessageBox.FContainer, 0) then
    begin

      if Anchor <> '' then
      begin
        DoCancel := false;
        if Assigned(FAdvSmartMessageBox.OnAnchorClick) then
          FAdvSmartMessageBox.OnAnchorClick(FAdvSmartMessageBox, FSmartMsg.Index ,Anchor, DoCancel);
...
procedure TAdvSmartMessageForm.MouseMove(Shift: TShiftState; X, Y: Integer);
var
  R, TextR, hr: TRect;
  Anchor, Stripped, FocusAnchor: string;
  XSize, YSize, HyperLinks, MouseLink: integer;
...
begin
  ...
  begin
    ...
    HTMLDrawEx(Canvas, FSmartMsg.Text, TextR, FAdvSmartMessageBox.FImages, 0, 0, -1, FAdvSmartMessageBox.FHoverLink, 1, False, False, False, False, True, False{FHover}, True, True,
      1.0, clBlue{FURLColor}, clNone, clNone, clGray, Anchor, Stripped, FocusAnchor, XSize, YSize,
...
procedure TAdvSmartMessageForm.SetAdvSmartMessageBox(const Value: TAdvSmartMessageBox);
begin
