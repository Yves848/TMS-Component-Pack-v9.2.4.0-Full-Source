...
begin
  ...
  0:
    begin
      MessageDlg(Component.ClassName+' version '+(Component as TAdvCustomMemo).GetVersionString+' for '+compiler+#13#10'© 2001-2019 by TMS software',
               mtinformation,[mbok],0);
    end;
  1:
    begin
      ShellExecute(0, 'open', 'http://www.tmssoftware.biz/download/manuals/TMS%20TAdvMemo.pdf', nil, nil, SW_SHOW);
    end;
  2:
    begin
      ShellExecute(0, 'open', 'https://www.tmssoftware.com/site/advmemo.asp?s=faq', nil, nil, SW_SHOW);
    end;
  end;
end;
