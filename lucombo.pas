...
const
  ...
  // v2.3.1.5 : Fixed : Issue with lookup of accented chars
  // v2.3.1.6 : Fixed : Issue with auto persisting values
...
begin
  if not (csDesigning in ComponentState) and not (csLoading in Parent.ComponentState) then
    SavePersist;
  DefaultHandler(msg);
end;
