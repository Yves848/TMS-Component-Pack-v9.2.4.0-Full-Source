...
uses
  Classes, AdvSmoothCalendar, AdvSmoothCalendarGroup, DesignIntf, DesignEditors;
...
begin
  ...
  begin
    ...
    if Component is TAdvSmoothCalendar then
      style := (Component as TAdvSmoothCalendar).GetComponentStyle
    else if Component is TAdvSmoothCalendarGroup then
      style := (Component as TAdvSmoothCalendarGroup).GetComponentStyle;
