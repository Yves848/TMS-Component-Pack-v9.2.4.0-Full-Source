...
procedure THTMLEditor.FormCanResize(Sender: TObject; var NewWidth,
  NewHeight: Integer; var Resize: Boolean);
begin
  Resize := (NewHeight > 227) and (NewWidth > 704);
end;
...
procedure THTMLEditor.Memo1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
