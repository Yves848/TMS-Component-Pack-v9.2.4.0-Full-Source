...
const
  ...
  // 1.6.2.1 : Improved : DropDown width on High DPI
...
begin
    ...
    if ((FState in [bsDown, bsExclusive]) or
      ...
      begin
        ...
        begin
          ...
          Canvas.MoveTo(PaintRect.Right - Round(DPIScale * 12), PaintRect.Top);
          Canvas.LineTo(PaintRect.Right - Round(DPIScale * 12), PaintRect.Bottom);
        end;
      end
      else
      begin
  ...
  begin
    ...
    Canvas.Polygon([Point(PaintRect.Right - Round(DPIScale * 8), Mid - Round(DPIScale)),
      Point(PaintRect.Right - Round(DPIScale * 4), Mid - Round(DPIScale)),Point(PaintRect.Right - Round(DPIScale * 6), Mid + Round(DPIScale))]);
    PaintRect.Right := PaintRect.Right - Round(DPIScale * 12);
  end;
...
begin
  ...
  begin
    if ((FDropDownButton) and (X > ClientRect.Right - Round(GetDPIScale(Self, Canvas) *12)))
