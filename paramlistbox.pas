...
begin
  ...
  begin
    ...
    // remaining rectangle space at the bottom of the scrolled component
  ...
  HTMLDrawEx(Canvas,Items[Index],hrect,FImages,pt.x,pt.y,fl,FHyperLink,FShadowOffset,
    False,False,False,(odSelected in State) and FShowSelection, False, FHover ,Multiline,FMouseDown,False,1.0,urlCol,
...
{$IFDEF DELPHIXE2_LVL}
procedure TParamListBox.CMStyleChanged(var Message: TMessage);
begin
  InitVCLStyle(true);
  Invalidate;
end;
...
procedure TParamListBox.InitVCLStyle(init: boolean);
{$IFDEF DELPHIXE2_LVL}
const
