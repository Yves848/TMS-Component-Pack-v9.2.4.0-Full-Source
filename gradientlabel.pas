...
begin
  ...
  cLineWidth := Round(FDPIScale * LineWidth);
  ...
  begin
    ...
    gtBottomLine: R.Top := R.Bottom - cLineWidth;
    gtTopLine: R.Bottom := R.Top + cLineWidth;
    gtCenterLine:
      begin
        R.Top := R.Top + (R.Bottom - R.Top - cLineWidth) div 2;
        R.Bottom := R.Top + cLineWidth;
      end;
    end;
  end
  else
  begin
    case GradientType of
    gtBottomLine: R.Left := R.Right - cLineWidth;
    gtTopLine: R.Right := R.Left + cLineWidth;
    gtCenterLine:
      begin
        R.Left := R.Left + (R.Right - R.Left - cLineWidth) div 2;
        R.Right := R.Left + cLineWidth;
      end;
    end;
  end;
