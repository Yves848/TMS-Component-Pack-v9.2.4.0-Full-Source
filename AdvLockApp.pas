...
const
  ...
  // v1.0.1.0 : New : Public method UnLock added
  //          : Fixed : Issue with remove component at design-time
  // v1.0.1.2 : Fixed : Issue with .UnLock call
