...
const
  ...
  // 2.5.1.2 : Improved : High DPI handling
...
{$IFDEF DELPHIXE10_LVL}
procedure THotSpotImage.ChangeScale(M, D: Integer; isDpiChange: Boolean);
begin
  inherited;
  Width := MulDiv(Width, d, m);
  Height := MulDiv(Height, d, m);
end;
{$ENDIF}

//------------------------------------------------------------------------------

procedure THotSpotImage.ChangeScale(M, D: Integer);
begin
  inherited;
  Width := MulDiv(Width, d, m);
  Height := MulDiv(Height, d, m);
