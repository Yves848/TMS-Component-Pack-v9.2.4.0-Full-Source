...
const
  ...
  // 1.5.1.0 : New : Public property State added
...
type
  ...
  TSplitterState = (stUnknown, stOpen, stClose);
  ...
  public
    ...
    property State: TSplitterState read FState;
  end;
...
begin
  ...
  if not FDbl and (FSplitterSize <> FOldSplitterSize) then
    FState := stUnknown;
