...
begin
  ...
  FPopupWindow.BkColorSelector.Tools[0].BackGroundColor := grid.Color;
  FPopupWindow.TxtColorSelector.Tools[0].BackGroundColor := grid.Font.Color;

  clr := grid.FontColors[GridCell.X, GridCell.Y];
