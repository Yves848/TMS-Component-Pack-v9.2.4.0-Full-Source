...
const
  ...
  // v1.6.4.2 : Fixed: Issue with transparent drawing of images from TImageList
  // v1.6.4.3 : Fixed : Issue with transparency on double buffered forms
  // v1.6.4.4 : Fixed : Issue with design-time PolyPager item editing
  // v1.6.4.5 : Fixed : Issue with Next,Previous key processing in specific cases
