...
begin
    ...
    begin
      ...
      begin
        ...
        Windows.DrawText(Canvas.Handle,
          ...
          DrawTextBiDiModeFlagsReadingOnly);
        with TextRect do
          ButtonWidths[B] := Right - Left + Round(16 * scale);
      end;
      ...
      begin
        ...
        Width := Max(Round(70*scale), ButtonWidths[B]);
        Height := ButtonHeight;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Height := Max(bh, Max(ButtonHeight, Canvas.TextHeight('gh') + Round(20*scale)));
  ...
  begin
    ...
    with TextRect do ButtonWidths[B] := Right - Left + Round(8*scale);
  ...
  if IconID <> nil then
  begin
    Inc(IconTextWidth, Round(32 *scale) + FHorzSpacing);
  end;
  ...
  begin
    ...
    begin
      ...
      SetBounds(FHorzMargin, Y - 5, Round(32*scale), Round(32*scale));
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        w := Max(w, Left + k + FHorzMargin + Round(20*scale));
      end;
  ...
  begin
    FExpTextXSize := 0;
    FExpTextYSize := 0;
    r := Rect(FHorzMargin, Y, 300, Y + Round(26*scale));
  ...
  itEdit, itPassword:
    begin
      ...
      FInputEdit.SetBounds(ALeft, Y + Round(20*scale), ClientWidth - ALeft, Round(20*scale));
    end;
  itComboEdit, itComboList:
    begin
      ...
      FInputCombo.SetBounds(ALeft, Y + Round(20*scale), ClientWidth - ALeft, Round(20*scale));
    end;
  itDate, itTime:
    begin
      ...
      FInputDate.Top := Y + Round(20*scale);
  ...
  itMemo:
    begin
      ...
      if UseRightToLeftAlignment then
        ALeft := Self.ClientWidth - ALeft - Width;
      FInputMemo.SetBounds(ALeft, Y + Round(20*scale), ClientWidth - ALeft, TaskDialog.InputMemoSettings.Height);
    end;
  itCustom:
    begin
      ...
      begin
        ...
        TaskDialog.InputControl.Top := Y + Round(20*scale);
  ...
  if (TaskDialog.InputType in [itEdit, itPassword]) and Assigned(FInputEdit) then
    FInputEdit.SetBounds(FInputEdit.Left, Y + Round(20*scale), ClientWidth - FInputEdit.Left - 15, Round(20*scale));

  if (TaskDialog.InputType in [itComboEdit, itComboList]) and Assigned(FInputCombo) then
    FInputCombo.SetBounds(FInputCombo.Left, Y + Round(20*scale), ClientWidth - FInputCombo.Left - 15, Round(20*scale));

  if (TaskDialog.InputType in [itMemo]) and Assigned(FInputMemo) then
    FInputMemo.SetBounds(FInputMemo.Left, Y + Round(20*scale), ClientWidth - FInputMemo.Left - 15, TaskDialog.InputMemoSettings.Height);
