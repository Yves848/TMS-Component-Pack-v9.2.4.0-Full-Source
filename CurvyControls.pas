...
const
  ...
  // v1.2.1.1 : Fixed : Issue with linebreaks in TCurvyMemo
  // v1.2.1.2 : Fixed : Issue with getting lines from TCurvyMemo when the control was not created
