...
const
  ...
  // 1.7.0.3 : Fixed : Issue with setting HintWidth = -1
  // 1.7.0.4 : Fixed : Complications with HintWidth = -1
...
begin
  ...
  begin
      ...
      begin
        ...
        begin
          ...
          HTMLDrawEx(Canvas,s, HR, FHint.ImageList, -1, -1, -1, -1, 2,
                     false, true, false, false, false, false, true, true, 1.0,
        ...
        begin
          ...
          begin
            hr.Right := 10000;
            dtfmt := DT_LEFT + DT_WORDBREAK + DT_CALCRECT;
          end;
    ...
    begin
      ...
      begin
        hr := Classes.Rect(0, 0, 10000, 100);
        dtfmt := DT_LEFT or DT_CALCRECT or DT_WORDBREAK or DT_NOPREFIX;
        TxtH := DrawText(Canvas.Handle, PChar(Caption), Length(Caption), hr, dtfmt);
        Rect.Bottom := Rect.Top + TxtH + TxtH div 3;
        Rect.Right := Rect.Left + hr.Right + 10;
      end;
    end;
        ...
        begin
          ...
          begin
            ...
            HTMLDrawEx(Canvas,s, DR, FHint.ImageList, -1, -1, -1, -1, 2,
                       false, false, false, false, false, false, true, true, 1.0,
                       clBlue, clNone, clNone, clGray,
                       av, sv, fa,
                       hxs, hys, fl, hl,
                       hr, nil, nil, 0);
