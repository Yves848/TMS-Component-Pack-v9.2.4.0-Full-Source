...
uses
  ...
  AdvSelectors, ComCtrls, Menus, ShellAPI, System.ImageList;
...
begin
  ...
  sl.Add('20');                                 // Size
  sl.Add(' Note the URL of TAdvOutLookList <A href="https://tmssoftware.com/site/tmsvcluipack.asp">TMS Software</A>');
  ...
  sl.Add(TimeToStr(RandomTime));                // Received
  sl.Add('30');                                 // Size
  sl.Add(' Kind Regards, if you have any problems contact us via <br><A href="info@tmssoftware.com"><B>TMS Software Info</B></A>');
  ...
  sl.Add('-1');                                // Attachement
  sl.Add('Mike Myers');                        // From
  sl.Add('Babysitter for 31 October');         // Subject
  sl.Add('3');                                 // Flag
  sl.Add(TimeToStr(RandomTime));               // Received
  sl.Add('70');                                // Size
  sl.Add('Have you already found a babysitter?<br><B>I really need one.</B>');

  sl := AdvOutlookList1.AddItem(olg);
  sl.Add('10');                                 // Envelop Image
  sl.Add('-1');                                 // Attachement
  sl.Add('Frederick K.');                       // From
  sl.Add('Springwood');                         // Subject
  sl.Add('3');                                  // Flag
  sl.Add(TimeToStr(RandomTime));                // Received
  sl.Add('90');                                 // Size
  sl.Add('Did you sleep well this <font color="clred"><b>night</b></font>?');
