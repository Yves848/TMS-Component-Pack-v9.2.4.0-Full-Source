...
unit UAdvSmoothImageListBoxImgBrowserDemo;
...
begin
  AdvSmoothImageListBox1.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[ComboBox1.ItemIndex]));
...
begin
  ...
  AdvSmoothImageListBox1.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[2]));
