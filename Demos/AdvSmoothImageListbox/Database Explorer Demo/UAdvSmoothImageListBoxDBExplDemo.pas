...
unit UAdvSmoothImageListBoxDBExplDemo;
...
uses
  ...
  AdvSmoothEditButton, AdvSmoothImageListBoxPicker, ShellAPI, Vcl.Mask;
...
begin
  ...
  AdvSmoothImageListBox1.Footer.Caption := inttostr(AdvSmoothImageListBox1.Items.Count) +' Cars';

  AdvSmoothImageListBoxPicker1.ListBox.Footer.Caption := AdvSmoothImageListBox1.Footer.Caption;

  //AdvSmoothImageListBoxPicker1.SetComponentStyle(TTMSStyle());
end;

procedure TForm131.Label3Click(Sender: TObject);
begin
