...
unit UAdvMemoCodeFoldingDemo;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, Grids, AdvMemo, AdvmPS, XPMan, StdCtrls, ExtCtrls, ShellAPI;
...
var
  ridx: integer;
begin
  AdvMemo1.Lines.LoadFromFile('.\UAdvMemoCodeFoldingDemo.pas');
...
procedure TFAdvMemoDemo04.Label4Click(Sender: TObject);
begin
...
begin
  if (SGRegions1.Col = 3) and (SGRegions1.Row > 0) and (SGRegions1.Row <= AdvPascalMemoStyler1.RegionDefinitions.Count) then
  begin
    FInputType.ShowModal;
  end
  else if SGRegions1.Cells[SGRegions1.Col, SGRegions1.Row] = '' then
  begin
    if (sgRegions1.Row>AdvPascalMemoStyler1.RegionDefinitions.Count)  then
        ...
        with AdvPascalMemoStyler1.RegionDefinitions.Add do
          ...
          AdvMemo1.Lines.Insert(18,'new' + #13 + #10 + 'begin' + #13 + #10 + '//this is a codefolding test' + #13 + #10 + 'end' + #13 + #10);
          end;
        end
      else
