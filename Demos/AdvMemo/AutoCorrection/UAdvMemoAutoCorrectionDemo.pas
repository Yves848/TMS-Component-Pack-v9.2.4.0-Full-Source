{*************************************************************************}
{ TAdvMemo, TDBAdvMemo demo 2 application                                 }
{                                                                         }
...
unit UAdvMemoAutoCorrectionDemo;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, AdvMemo, Grids, ImgList, XPMan, System.ImageList, ShellAPI,
...
begin
  ...
  begin
     ...
     AdvMemo1.Lines.Add('');
     AdvMemo1.Lines.Add('Auto correcting text: ');
     AdvMemo1.Lines.Add('');
     AdvMemo1.Lines.Add('');
...
procedure TFAdvMemoDemo02.Label4Click(Sender: TObject);
begin
