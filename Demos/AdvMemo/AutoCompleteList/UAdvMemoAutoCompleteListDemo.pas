...
unit UAdvMemoAutoCompleteListDemo;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, StrUtils, StdCtrls, AdvMemo, AdvmPS, XPMan, AdvMemoStylerManager,
  ShellAPI, ExtCtrls;
...
procedure TFAdvMemoDemo05.Label4Click(Sender: TObject);
begin
