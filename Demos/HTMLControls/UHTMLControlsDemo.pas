...
uses
  ...
  System.ImageList, Vcl.ExtCtrls, Vcl.ActnMan;
...
begin
 if hintinfo.HintControl = Button1 then hintinfo.hintcolor:=clGray;
 if hintinfo.HintControl = Button3 then hintinfo.hintcolor:=clAqua;
end;
...
begin
  ...
  htmltreeview1.Items.Add(nil,'<img src="ssys:word.docx"> <a href="Clicked on my Word file">My Word file</a> ');
  htmltreeview1.Items.Add(nil,'<img src="ssys:word.xlsx"> <a href="Clicked on my Excel file">My Excel file</a> ');
...
begin
  ...
  if anchor='anchor'  then sublabel.htmltext.Add('Anchors to <A href="http://www.tmssoftware.com">websites</A>, <A href="mailto:info@tmssoftware.com">email</A>, <A href="file://c:\">folders</A> or custom actions are provided');
  if anchor='image'  then sublabel.htmltext.Add('Images and imagelist elements <IMG src="idx:1"> can be mixed <IMG src="idx:2"> with HTML formatted text.<BR>Images can be : BMP, JPG or GIF');
...
begin
  ...
  if anchor='anchor' then HtmlStaticText4.htmltext.Add('Anchors to <A href="http://www.tmssoftware.com">websites</A>, <A href="mailto:info@tmssoftware.com">email</A>, <A href="file://c:\">folders</A> or custom actions are provided');
  if anchor='image' then HtmlStaticText4.htmltext.Add('Images and imagelist elements <IMG src="idx:1"> can be mixed <IMG src="idx:2"> with HTML formatted text.<BR>Images can be : BMP, JPEG and GIF');
  ...
  if anchor='animation' then HtmlStaticText4.htmltext.Add('<BR>Now supports pictures like animated GIFs <IMG src="tms"> from the attached PictureContainer in the label and image hover effects <A href="This is a fly-over image"><IMG src="GREY" ALT="COLOR"></A>');
