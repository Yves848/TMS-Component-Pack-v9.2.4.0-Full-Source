{********************************************************************}
{ TMS TPlannerRangeSelector Demo                                     }
{                                                                    }
{                                                                    }
...
unit UPlannerRangeSelectorDemos;
...
uses
  ...
  ExtCtrls, PlannerCal, Menus, ShellAPI, AdvEdBtn;
...
begin
  PlannerRangeSelector1.DateEnd := Now + 1;
  PlannerRangeSelector1.DateStart := Now;
end;

procedure TForm92.Label19Click(Sender: TObject);
begin
