object FormMain: TFormMain
  ...
  object CdsEmployee: TClientDataSet
    ...
    Left = 360
    Top = 8
    object CdsEmployeeEmpNo: TIntegerField
      FieldName = 'EmpNo'
    end
    ...
    object CdsEmployeePhoneExt: TStringField
      FieldName = 'PhoneExt'
      Size = 4
    end
    object CdsEmployeeHireDate: TDateTimeField
      FieldName = 'HireDate'
    end
    object CdsEmployeeSalary: TFloatField
      FieldName = 'Salary'
      OnGetText = CdsEmployeeSalaryGetText
    end
  end
end
