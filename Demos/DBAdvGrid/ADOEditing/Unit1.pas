...
uses
  ...
  ADODB, StdCtrls, AdvObj, AdvGridColPicker, AdvUtil;
...
type
  TForm1 = class(TForm)
    ...
    procedure DBAdvGrid1GetEditorProp(Sender: TObject; ACol, ARow: Integer;
      AEditLink: TEditLink);
  private
...
begin
  if ACol = 8 then
  begin
    DBAdvGrid1.Combobox.Items.Clear;
    ...
    DBAdvGrid1.Combobox.Items.Add('United Kingdom');
  end;
end;
