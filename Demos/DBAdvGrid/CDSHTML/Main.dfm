object FormMain: TFormMain
  Left = 543
  Top = 204
  Caption = 'CDS HTML Template sample'
  ClientHeight = 299
  ClientWidth = 473
  Color = clBtnFace
  ...
  object SrcAnimals: TDataSource
    DataSet = CdsAnimals
    Left = 328
  end
  object CdsAnimals: TClientDataSet
    Aggregates = <>
    FileName = 'animals.xml'
    Params = <>
    Left = 384
    object CdsAnimalsNAME: TStringField
      DisplayLabel = 'Name'
      FieldName = 'NAME'
      Size = 10
    end
    object CdsAnimalsSIZE: TSmallintField
      DisplayLabel = 'Size'
      FieldName = 'SIZE'
    end
    object CdsAnimalsWEIGHT: TSmallintField
      DisplayLabel = 'Weight'
      FieldName = 'WEIGHT'
    end
    object CdsAnimalsAREA: TStringField
      DisplayLabel = 'Area'
      FieldName = 'AREA'
    end
    object CdsAnimalsBMP: TBlobField
      FieldName = 'BMP'
