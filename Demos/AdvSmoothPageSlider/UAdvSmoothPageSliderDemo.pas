...
uses
  ...
  ShellAPI, AdvStyleIF, AdvAppStyler;
...
var
  i: Integer;
begin
  AdvFormStyler1.Style:= tsWindows8;
  ...
  DBAdvSmoothListBox1.SendToBack;
end;
...
procedure TForm600.Label9Click(Sender: TObject);
begin
