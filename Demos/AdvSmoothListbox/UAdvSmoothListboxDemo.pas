...
begin
  ...
  AdvSmoothListBox3.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[ComboBox1.ItemIndex]));
  AdvSmoothListBox7.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[ComboBox1.ItemIndex]));
  AdvSmoothListBox8.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[ComboBox1.ItemIndex]));
  AdvSmoothListBox9.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[ComboBox1.ItemIndex]));
...
const
  contactlist: array[0..19] of string = ('John', 'Mike', 'Laura', 'Steven', 'Jenna', 'Peter',
    'Bruce', 'Roger', 'Alton', 'Byron', 'Curtis', 'Brad', 'Andre', 'April',
...
begin
  ...
  begin
    ...
    begin
      ...
      Notes := '<font size="8"><b>Call: ' + name + '</b></font><br/><font size="8">my </font>' +
      '<font size="8" color="clGray">email address </font><font size="8">is </font><font size="8">' +
  ...
  AdvSmoothListBox3.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[1]));
  AdvSmoothListBox6.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[1]));
  AdvSmoothListBox7.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[4]));
  AdvSmoothListBox8.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[4]));
  AdvSmoothListBox9.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[4]));
  ...
  begin
    ...
    begin
      ...
      Info := FormatDateTime('dd/mm/yyyy', EncodeDate(SysUtils.CurrentYear, CategoryID + 1, RandomRange(4, 25)));
    end;
  end;
  AdvSmoothListBox4.Items.Sort;
  ...
  AdvSmoothListBox10.Header.Fill.Color := RGB(67,184,250);
  AdvSmoothListBox10.Header.Fill.BorderColor := RGB(45,54,66);
  AdvSmoothListBox10.Fill.Color := clBlack;
  AdvSmoothListBox10.Header.Fill.ColorTo := RGB(67,184,250);
  ...
  AdvSmoothListBox10.ItemAppearance.FillAlterNate.Color := RGB(67,184,250);
  AdvSmoothListBox10.ItemAppearance.FillAlternate.Rounding := 20;
  ...
  AdvSmoothListBox10.ItemAppearance.FillAlterNate.BorderColor := clBlack;

  AdvSmoothListBox10.ItemAppearance.Fill.Color := RGB(229,228,234);
  AdvSmoothListBox10.ItemAppearance.Fill.Rounding := 20;
  AdvSmoothListBox10.ItemAppearance.Fill.GradientType := gtsolid;
  AdvSmoothListBox10.ItemAppearance.Fill.ColorMirror := clNone;
  AdvSmoothListBox10.ItemAppearance.Fill.BorderColor := clBlack;
...
procedure TForm67.Label20Click(Sender: TObject);
begin
