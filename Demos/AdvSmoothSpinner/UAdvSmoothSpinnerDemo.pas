...
unit UAdvSmoothSpinnerDemo;

interface

uses
  Forms, Windows, Controls, StdCtrls, ExtCtrls, AdvSmoothSpinner, ComCtrls, ImgList,
  Classes, GDIPPictureContainer, AdvStyleIF, SysUtils, Math, System.ImageList,
  ShellAPI;
...
begin
  AdvSmoothSpinner3.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[ComboBox1.ItemIndex]));
end;
...
begin
  ...
  AdvSmoothSpinner3.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[2]));
  AdvSmoothSpinner1.SetComponentStyle(tsWindows10);
  AdvSmoothSpinner2.SetComponentStyle(tsOffice2016Gray);
end;

procedure TForm148.Label16Click(Sender: TObject);
begin
