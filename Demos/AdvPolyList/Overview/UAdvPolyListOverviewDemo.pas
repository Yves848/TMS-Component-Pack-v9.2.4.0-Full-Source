...
var
  ...
  test: string;
begin
  HTMLItem6.Description := '<font size="8"><ul><li><u>Meeting</u> with Steve at 8AM </li>'+
  ...
  HTMLSectionItem2.Description:='<font color="clgreen">('+DateToStr(Date)+')</font>';
...
procedure TForm665.Label16Click(Sender: TObject);
begin
