{********************************************************************}
{ TAdvDBFormPanel DEMO application                                      }
{                                                                    }
...
uses
  ...
  AdvEdit, DBAdvEd, AdvDBFormLayouter, ShellAPI;
...
begin
  ...
  begin
    ...
    Add('Hp',ftInteger, 0, True);
    Add('Max Speed',ftInteger, 0, True);
  ...
  ClientDataSet2.FieldByName('Hp').AsInteger := 1998;
  ClientDataSet2.FieldByName('Max Speed').AsInteger := 136;
  ...
  ClientDataSet2.FieldByName('Hp').AsInteger := 4998;
  ClientDataSet2.FieldByName('Max Speed').AsInteger := 470;
