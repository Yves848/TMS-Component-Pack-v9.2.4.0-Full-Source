...
uses
  ...
  AdvMetroButton, AdvMetroProgressBar, StdCtrls, ShellAPI, System.ImageList;
...
procedure TTMSForm1.AdvMetroTile2Click(Sender: TObject);
begin
  ShellExecute(handle,'open','https://tmssoftware.com/site/tmsvcluipack.asp', nil, nil, SW_SHOWNORMAL);
end;

procedure TTMSForm1.AdvMetroTile3Click(Sender: TObject);
begin
  WinExec('cmd',SW_SHOW)
end;
