...
unit UAdvSmoothTileListProductDemo;
...
begin
  AdvSmoothTileList1.SetComponentStyle(TTMSStyle(ComboBox1.Items.Objects[ComboBox1.ItemIndex]));
end;

procedure TForm327.FormAfterMonitorDpiChanged(Sender: TObject; OldDPI,
  NewDPI: Integer);
begin
  AdvSmoothTileList1.TileAppearance.SmallViewFont.Size := Round(Monitor.PixelsPerInch/Form327.PixelsPerInch * 7);
end;
...
procedure TForm327.Label6Click(Sender: TObject);
begin
