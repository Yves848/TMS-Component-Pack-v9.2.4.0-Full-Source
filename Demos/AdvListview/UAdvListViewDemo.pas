...
uses
  ...
  UAdvListViewprev, ShellAPI, ImgList, System.ImageList;
...
begin
  MessageDlg('TAdvListView version ' + AdvListView1.GetVersionString + #13 + #10 + '© 1998-'+ SysUtils.CurrentYear.ToString +' by TMS software', mtInformation, [mbok], 0);
end;
...
begin
  ...
  begin
     country:= AdvListView2.Items.Item[i].SubItems[4];

     if country='Germany' then advlistview2.subitemimages[i, 4] := 3 else
     if country='Italy' then advlistview2.subitemimages[i, 4] := 4 else
     if country='UK' then advlistview2.subitemimages[i, 4] := 5 else
     if country='France' then advlistview2.subitemimages[i, 4] := 2 else
     if country='USA' then advlistview2.subitemimages[i, 4] := 6
     else advlistview2.subitemimages[i, 4] := -1;
     end;
...
begin
  ...
  advlistview2.RichToItem(0, 0, advlistview2.Richedit);
end;
...
begin
  advlistview2.CutSelectionToClipboard;
end;
...
begin
  ...
  advlistview2.items[0].subitems[0] := '<IMG src="idx:0"> is an image<B></B>';
  advlistview2.items[1].subitems[0] := 'This is an <A HREF="action">anchor</A>';
  advlistview2.items[2].subitems[0] := 'This is the URL <A HREF="https://tmssoftware.com/site/tmsvcluipack.asp">www.tmssoftware.com</A>';
  exit;
  advlistview2.autosizecolumns;
...
begin
  ...
  begin
    ...
    advlistview1.itemheight := Round(50*Monitor.PixelsPerInch/96);
  end
  else
  begin
    advlistview1.detailview.visible := false;
    advlistview1.itemheight := Round(16*Monitor.PixelsPerInch/96);
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      SubItems.Add('D2 to the latest released version');
      SubItems.Add('Feb 15, 2001');
      SubItems.Add('<a href="https://tmssoftware.com/site/tmsvcluipack.asp">View</a>');
    ...
    begin
      ...
      SubItems.Add('D3 to the latest released version');
      SubItems.Add('Feb 15, 2001');
      SubItems.Add('<a href="https://tmssoftware.com/site/tmsvcluipack.asp">View</a>');
