...
uses
  ...
  Buttons, AdvGDIP, ComCtrls, ShellAPI;
...
begin
  ...
  1: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2007Luna);
  2: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2007Obsidian);
  3: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2007Silver);
  4: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2010Blue);
  5: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2010Silver);
  6: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2010Black);
  7: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2013White);
  8: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2013LightGray);
  9: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2013Gray);
  10: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2016White);
  11: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2016Gray);
  12: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2016Black);
//  13: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2019White);
//  14: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2019Gray);
//  15: AdvSmoothRotaryMenu1.SetComponentStyle(tsOffice2019Black);
  16: AdvSmoothRotaryMenu1.SetComponentStyle(tsWhidbey);
  17: AdvSmoothRotaryMenu1.SetComponentStyle(tsWindowsXP);
  18: AdvSmoothRotaryMenu1.SetComponentStyle(tsWindowsVista);
  19: AdvSmoothRotaryMenu1.SetComponentStyle(tsWindows7);
  20: AdvSmoothRotaryMenu1.SetComponentStyle(tsWindows8);
  21: AdvSmoothRotaryMenu1.SetComponentStyle(tsTerminal);
  end;
end;
...
procedure TForm832.Label16Click(Sender: TObject);
begin
