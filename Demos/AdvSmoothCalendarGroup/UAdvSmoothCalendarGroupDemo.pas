...
unit UAdvSmoothCalendarGroupDemo;
...
uses
  ...
  GDIPPictureContainer, Buttons, ShellAPI;
...
var
  d: TDate;
begin
  d := EncodeDate(AdvSmoothCalendarGroup1.Year,1,1);
  ...
  case ComboBox1.ItemIndex of
    ...
    begin
      ...
      AdvSmoothCalendarGroup1.SelectDisjunctDates([d + 50, d + 260, d + 125, d + 40, d + 135, d + 340, d + 10]);
    end;
  end;
end;
...
begin
  AdvSmoothCalendarGroup1.SetComponentStyle(GetDefaultStyle);
...
procedure TForm790.Label2Click(Sender: TObject);
begin
