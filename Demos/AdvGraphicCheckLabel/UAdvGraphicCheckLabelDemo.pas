{********************************************************************}
{ TMS TAdvGraphicCheckLabel Demo                                     }
...
unit UAdvGraphicCheckLabelDemo;
...
begin
  case (Sender as TComboBox).ItemIndex of
    ...
    2 : begin
          AdvGraphicCheckLabel2.Kind := ckCheck;
          AdvGraphicCheckLabel2.StateChecked.Text := 'Checked';
          AdvGraphicCheckLabel2.StateUnChecked.Text := 'Unchecked';
        end;
...
procedure TForm92.Label7Click(Sender: TObject);
begin
