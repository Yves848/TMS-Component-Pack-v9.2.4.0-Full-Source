...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, HTMLForm, ImgList, HTMLabel, System.ImageList;
...
type
  TForm369 = class(TForm)
    ...
    procedure HTMLForm1ControlClick(Sender: TObject; CtrlID, CtrlType,
      CtrlVal: string);
...
procedure TForm369.HTMLForm1ControlClick(Sender: TObject; CtrlID, CtrlType,
  CtrlVal: string);
begin
  if CtrlID = 'BTN1' then
  begin
    HTMLForm1.SetValue('CK1', 'false');
    HTMLForm1.SetValue('ED1', '');
    HTMLForm1.SetValue('ED2', '');
    HTMLForm1.SetValue('CO1', '');
    HTMLForm1.SetValue('CO2', '');
    HTMLForm1.SetValue('RD1', 'true');
    HTMLForm1.SetValue('ED3', '');
  end;
end;
...
procedure TForm369.Label19Click(Sender: TObject);
begin
