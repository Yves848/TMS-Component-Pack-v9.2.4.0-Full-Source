...
uses
  ...
  ComCtrls, Buttons, Clipbrd, PictureContainer, jpeg, AdvStyleIF, ShellAPI ;
...
begin
  ...
  begin
    AdvSmartMessageBox1.SetComponentStyle(TTMSStyle(ComboBox3.Items.Objects[ComboBox3.ItemIndex]));
    CustomColor := false;
  end
  else
  begin
...
begin
  ...
  FillStyleList(ComboBox3.Items);
  ComboBox3.Items.Insert(0,'Custom colors');
