...
uses
  ShlObj, ShellAPI, ActiveX, AdvStyleIF;
...
begin
  ...
  0:begin
      {$I COMPILERTEXT.INC}
      MessageDlg(Component.ClassName+' version '+ (Component as TCustomPlanner).VersionString + ' for ' + compiler + #13#10#13#10'© 1999-2018 by TMS software'#13#10'https://www.tmssoftware.com',
  ...
  8:
     begin
       ShellExecute(0, 'open', 'http://www.tmssoftware.biz/download/manuals/TMS%20TPLANNER.pdf', nil, nil, SW_SHOW);
     end;
  9:
     begin
       ShellExecute(0, 'open', 'http://www.tmssoftware.com/site/planner.asp?s=faq', nil, nil, SW_SHOW);
     end;
  end;
end;
