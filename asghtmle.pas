...
const
  ...
  colorTable: array[0..171] of TColorEntry = (
    (sc:'3ddkshadow';tc:clgraytext),
    (sc:'3dlight';tc:cl3dlight),
    (sc:'activeborder';tc:clActiveborder),
    (sc:'activecaption';tc:clActivecaption),
    (sc:'aliceblue';tc:$FFF8F0),
    (sc:'antiquewhite';tc:$D7EBFA),
    (sc:'appworkspace';tc:clAppworkspace),
    (sc:'aqua';tc:$FFFF00),
    (sc:'aquamarine';tc:$D4FF7F),
    (sc:'azure';tc:$FFFFF0),
    (sc:'background';tc:clBackground),
    (sc:'beige';tc:$DCF5F5),
    (sc:'bisque';tc:$C4E4FF),
    (sc:'black';tc:$000000),
    (sc:'blanchedalmond';tc:$CDEBFF),
    (sc:'blue';tc:$FF0000),
    (sc:'blueviolet';tc:$E22B8A),
    (sc:'brown';tc:$2A2AA5),
    (sc:'btnface';tc:clBtnface),
    (sc:'btnhighlight';tc:clBtnhighlight),
    (sc:'btnshadow';tc:clBtnshadow),
    (sc:'btntext';tc:clBtntext),
    (sc:'burlywood';tc:$87B8DE),
    (sc:'cadetblue';tc:$A09E5F),
    (sc:'captiontext';tc:clCaptiontext),
    (sc:'chartreuse';tc:$00FF7F),
    (sc:'chocolate';tc:$1E69D2),
    (sc:'coral';tc:$507FFF),
    (sc:'cornflowerblue';tc:$ED9564),
    (sc:'cornsilk';tc:$DCF8FF),
    (sc:'crimson';tc:$3C14DC),
    (sc:'cyan';tc:$FFFF00),
    (sc:'darkblue';tc:$8B0000),
    (sc:'darkcyan';tc:$8B8B00),
    (sc:'darkgoldenrod';tc:$0B86B8),
    (sc:'darkgray';tc:$A9A9A9),
    (sc:'darkgreen';tc:$006400),
    (sc:'darkgrey';tc:$A9A9A9),
    (sc:'darkkhaki';tc:$6BB7BD),
    (sc:'darkmagenta';tc:$8B008B),
    (sc:'darkolivegreen';tc:$2F6B55),
    (sc:'darkorange';tc:$008CFF),
    (sc:'darkorchid';tc:$CC3299),
    (sc:'darkred';tc:$00008B),
    (sc:'darksalmon';tc:$7A96E9),
    (sc:'darkseagreen';tc:$8FBC8F),
    (sc:'darkslateblue';tc:$8B3D48),
    (sc:'darkslategray';tc:$4F4F2F),
    (sc:'darkslategrey';tc:$4F4F2F),
    (sc:'darkturquoise';tc:$D1CE00),
    (sc:'darkviolet';tc:$D30094),
    (sc:'deeppink';tc:$9314FF),
    (sc:'deepskyblue';tc:$FFBF00),
    (sc:'dimgray';tc:$696969),
    (sc:'dimgrey';tc:$696969),
    (sc:'dodgerblue';tc:$FF901E),
    (sc:'firebrick';tc:$2222B2),
    (sc:'floralwhite';tc:$F0FAFF),
    (sc:'forestgreen';tc:$228B22),
    (sc:'fuchsia';tc:$FF00FF),
    (sc:'gainsboro';tc:$DCDCDC),
    (sc:'ghostwhite';tc:$FFF8F8),
    (sc:'gold';tc:$00D7FF),
    (sc:'goldenrod';tc:$20A5DA),
    (sc:'gray';tc:$808080),
    (sc:'graytext';tc:clGraytext),
    (sc:'green';tc:$008000),
    (sc:'greenyellow';tc:$2FFFAD),
    (sc:'grey';tc:$808080),
    (sc:'highlight';tc:clHighlight),
    (sc:'highlighttext';tc:clHighlighttext),
    (sc:'honeydew';tc:$F0FFF0),
    (sc:'hotpink';tc:$B469FF),
    ...
    (sc:'indianred';tc:$5C5CCD),
    (sc:'indigo';tc:$82004B),
    (sc:'infobk';tc:clInfobk),
    (sc:'infotext';tc:clInfotext),
    (sc:'ivory';tc:$F0FFFF),
    (sc:'khaki';tc:$8CE6F0),
    (sc:'lavender';tc:$FAE6E6),
    (sc:'lavenderblush';tc:$F5F0FF),
    (sc:'lawngreen';tc:$00FC7C),
    (sc:'lemonchiffon';tc:$CDFAFF),
    (sc:'lightblue';tc:$E6D8AD),
    (sc:'lightcoral';tc:$8080F0),
    (sc:'lightcyan';tc:$FFFFE0),
    (sc:'lightgoldenrodyellow';tc:$D2FAFA),
    (sc:'lightgray';tc:$D3D3D3),
    (sc:'lightgreen';tc:$90EE90),
    (sc:'lightgrey';tc:$D3D3D3),
    (sc:'lightpink';tc:$C1B6FF),
    (sc:'lightsalmon';tc:$7AA0FF),
    (sc:'lightseagreen';tc:$AAB220),
    (sc:'lightskyblue';tc:$FACE87),
    (sc:'lightslategray';tc:$998877),
    (sc:'lightslategrey';tc:$998877),
    (sc:'lightsteelblue';tc:$DEC4B0),
    (sc:'lightyellow';tc:$E0FFFF),
    (sc:'lime';tc:$00FF00),
    (sc:'limegreen';tc:$32CD32),
    (sc:'linen';tc:$E6F0FA),
    (sc:'magenta';tc:$FF00FF),
    (sc:'maroon';tc:$000080),
    (sc:'mediumaquamarine';tc:$AACD66),
    (sc:'mediumblue';tc:$CD0000),
    (sc:'mediumorchid';tc:$D355BA),
    (sc:'mediumpurple';tc:$DB7093),
    (sc:'mediumseagreen';tc:$71B33C),
    (sc:'mediumslateblue';tc:$EE687B),
    (sc:'mediumspringgreen';tc:$9AFA00),
    (sc:'mediumturquoise';tc:$CCD148),
    (sc:'mediumvioletred';tc:$8515C7),
    (sc:'menu';tc:clMenu),
    (sc:'menutext';tc:clMenutext),
    (sc:'midnightblue';tc:$701919),
    (sc:'mintcream';tc:$FAFFF5),
    (sc:'mistyrose';tc:$E1E4FF),
    (sc:'moccasin';tc:$B5E4FF),
    (sc:'navajowhite';tc:$ADDEFF),
    (sc:'navy';tc:$800000),
    (sc:'oldlace';tc:$E6F5FD),
    (sc:'olive';tc:$008080),
    (sc:'olivedrab';tc:$238E6B),
    (sc:'orange';tc:$00A5FF),
    (sc:'orangered';tc:$0045FF),
    (sc:'orchid';tc:$D670DA),
    (sc:'palegoldenrod';tc:$AAE8EE),
    (sc:'palegreen';tc:$98FB98),
    (sc:'paleturquoise';tc:$EEEEAF),
    (sc:'palevioletred';tc:$9370DB),
    (sc:'papayawhip';tc:$D5EFFF),
    (sc:'peachpuff';tc:$B9DAFF),
    (sc:'peru';tc:$3F85CD),
    (sc:'pink';tc:$CBC0FF),
    (sc:'plum';tc:$DDA0DD),
    (sc:'powderblue';tc:$E6E0B0),
    (sc:'purple';tc:$800080),
    (sc:'rebeccapurple';tc:$993366),
    (sc:'red';tc:$0000FF),
    (sc:'rosybrown';tc:$8F8FBC),
    (sc:'royalblue';tc:$E16941),
    (sc:'saddlebrown';tc:$13458B),
    (sc:'salmon';tc:$7280FA),
    (sc:'sandybrown';tc:$60A4F4),
    (sc:'seagreen';tc:$578B2E),
    (sc:'seashell';tc:$EEF5FF),
    (sc:'sienna';tc:$2D52A0),
    (sc:'silver';tc:$C0C0C0),
    (sc:'skyblue';tc:$EBCE87),
    (sc:'slateblue';tc:$CD5A6A),
    (sc:'slategray';tc:$908070),
    (sc:'slategrey';tc:$908070),
    (sc:'snow';tc:$FAFAFF),
    (sc:'springgreen';tc:$7FFF00),
    (sc:'steelblue';tc:$B48246),
    (sc:'tan';tc:$8CB4D2),
    (sc:'teal';tc:$808000),
    (sc:'thistle';tc:$D8BFD8),
    (sc:'tomato';tc:$4763FF),
    (sc:'turquoise';tc:$D0E040),
    (sc:'violet';tc:$EE82EE),
    (sc:'wheat';tc:$B3DEF5),
    (sc:'white';tc:$FFFFFF),
    (sc:'whitesmoke';tc:$F5F5F5),
    (sc:'window';tc:clWindow),
    (sc:'windowframe';tc:clWindowframe),
    (sc:'windowtext';tc:clWindowtext),
    (sc:'yellow';tc:$00FFFF),
    (sc:'yellowgreen';tc:$32CD9A)
    );
...
var
  ...
  HTMLEncodedChar : array[1..NumSpecialChar] of ansistring = ('&','<','>','"',' ',
                                                     'é','è','ë','ê',
                                                     'ó','ò','ö','ô',
                                                     'í','ì','ï','î',
                                                     'ú','ù','ü','û',
  ...
  HTMLSpecialChar : array[1..NumSpecialChar] of string = ('amp;','lt;','gt;','&quot;','&nbsp;',
  ...
  (*
  HTMLEncodedChar : array[1..70] of ansistring = ('é','è','ë','ê',
                                             'ó','ò','ö','ô',
                                             'í','ì','ï','î',
                                             'ú','ù','ü','û',
                                             'á','à','ä','â',
  ...
  HTMLSpecialChar : array[1..70] of ansistring = ('&eacute;','&egrave;','&euml;','&ecirc;',
                                             '&oacute;','&ograve;','&ouml;','&ocirc;',
                                             '&iacute;','&igrave;','&iuml;','&icirc;',
                                             '&uacute;','&ugrave;','&uuml;','&ucirc;',
                                             '&aacute;','&agrave;','&auml;','&acirc;',
...
function FirstChar(sub:string; s: string): integer;
var
  i,j: integer;
begin
  Result := -1;
...
var
  su: string;
  r,dr,hr,rr,er: TRect;
  htmlwidth,htmlheight,txtheight,ch,fc: Integer;
  Align: TAlignment;
  PIndent: Integer;
  OldFont: TFont;
  CalcFont: TFont;
  ...
  begin
    ...
    begin
      ...
      for spc := 4 to NumSpecialChar do
      begin
                ...
                if TagChar = '>' then  // <B> tag
                  ...
                  begin
                    ...
                    begin
                      ...
                      if (Pos('FONT-FAMILY',TagProp) > 0) then
                      begin
                        Prop := Copy(TagProp,Pos('FONT-FAMILY',TagProp)+11,Length(TagProp));
                        Prop := Copy(Prop,Pos(ASG_ATTR_DELIM,Prop)+1,Length(prop));
                        Prop := Copy(Prop,1,Pos(ASG_ATTR_DELIM,Prop)-1);
                        Canvas.Font.Name := Prop;
                      end;

                      if (Pos('FONT-SIZE',TagProp) > 0) then
                      begin
                        Prop := Copy(TagProp,Pos('FONT-SIZE',TagProp)+10,Length(TagProp));
                        fc := FirstChar(';''"', Prop);
                        if fc > 0 then
                          Prop := Copy(Prop,1,fc-1);

                        if pos('PT', Prop) > 0 then
                          Prop := Copy(Prop, 1, Length(Prop) - 2);
                      ...
                      if (Pos('FONT-STYLE',TagProp) > 0) then
                      begin
                        Prop := Copy(TagProp,Pos('FONT-STYLE',TagProp)+11,Length(TagProp));
                        fc := FirstChar(';''"', Prop);
                        if fc > 0 then
                          Prop := Copy(Prop,1,fc - 1);
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      Canvas.Brush.Color := clWhite;
                      Canvas.Brush.Style := bsSolid;
                      Canvas.Rectangle(cr.Left ,cr.Bottom - h + 4,cr.Left + Indent, cr.Bottom + 1);

                      Canvas.Brush.Style := bsClear;
                      ir := Rect(cr.Left + 4,cr.Bottom - h + 4,cr.Left + Indent - Round(18*scale), cr.Bottom);
                      DrawText(Canvas.Handle,PChar(ControlValue),Length(ControlValue),ir,DT_LEFT or DT_SINGLELINE or DT_VCENTER);

                      ir := Rect(cr.Left + Indent - Round(18*scale),cr.Bottom - h + 5,cr.Left + Indent - 1, cr.Bottom + 1);
                    ...
                    begin
                      IMGSize.x := Round(16*scale);
                      IMGSize.y := Round(16*scale);
                      Indent := Round(16*scale);
                      ...
                      if UseWinXp then
                        ...
                        Canvas.Pen.Color := clGray;
                      Canvas.Brush.Style := bsClear;
                      ir := Rect(cr.Left + 2,cr.Bottom - Round(14*scale),cr.Left + Round(14*scale), cr.Bottom);
                  ...
                  if (ControlType = 'CHECK') or (ControlType = 'RADIO') then
                  begin
                    IMGSize.x := Round(16 * scale * ResFactor);
                    IMGSize.y := Round(16 * scale);
                  end;
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      TagHeight := Round(TagHeight * scale);
                    end;
                    ...
                    begin
                      ...
                      begin
                        //IMGSize.x := Round(FImages.Width * scale);
                        //IMGSize.y := Round(FImages.Height * scale);
...
// {changed}               cr := r;
                    ...
                    begin
                      ...
                      //IMGSize.x := Round(IMGSize.X * scale);
                      //IMGSize.y := Round(IMGSize.Y * scale);
                    end;
                    ...
                    begin
                      ...
                      begin
                        ...
                        begin
                          ...
                          if (TagWidth = 0) and (TagHeight = 0) then
                          begin
                            imgw := Round(bmp.Width* scale);
                            imgh := Round(bmp.Height * scale);
                          end;
                          if not Calc {and not Print} then
                          begin
                            if (TagWidth > 0) and (TagHeight > 0) then
                            ...
                            begin
                              ...
                              begin
                                ...
                                Canvas.StretchDraw(Rect(flr.Left + (bmp as THTMLPicture).FrameXPos, flr.Top + (bmp as THTMLPicture).FrameYPos,
                                  flr.Left + (bmp as THTMLPicture).FrameXPos + imgw, flr.Top + (bmp as THTMLPicture).FrameYPos + imgh), bmp);
                              end
                              else
                                Canvas.StretchDraw(Rect(flr.Left,flr.Top,flr.Left + imgw, flr.Top + imgh), bmp);
                            end;
                          ...
                          begin
                            if (bmp is THTMLPicture) then
                            begin
                              //ImgSize.x := Round((bmp as THTMLPicture).MaxWidth * scale);
                              //ImgSize.y := Round((bmp as THTMLPicture).MaxHeight * scale);
                            ...
                            begin
                              //IMGSize.x := Round(bmp.Width * scale);
                              //IMGSize.y := Round(bmp.Height * scale);
...
begin
  ...
  begin
    repeat
      ...
      if TagReplacestring('&szlig;','ß',s) then Foundtag := True;
      *)
    until not Foundtag;
  end;
