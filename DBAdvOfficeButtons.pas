...
const
  ...
  // v1.0.1.2 : Fixed : Issue with TDBAdvOfficeCheckBox for use in TDBCtrlGrid
  // v1.1.0.0 : New : Event OnChanged added in TDBAdvOfficeRadioGroup, TDBAdvOfficeCheckGroup
...
type
  ...
  protected
    ...
    function GetCheckState: TCheckBoxState; override;
  public
...
function TDBAdvOfficeCheckBox.GetCheckState: TCheckBoxState;
begin
