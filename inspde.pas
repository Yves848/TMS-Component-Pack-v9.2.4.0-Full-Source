...
uses
  Classes, InspectorBar, InspImg, Controls, DesignIntf, DesignEditors;
...
begin
  ...
  0:begin
    ...
    MessageDlg(Component.ClassName+' version '+(Component as TInspectorBar).VersionString+' for '+compiler+#13#10'© 2001-2016 by TMS software',
