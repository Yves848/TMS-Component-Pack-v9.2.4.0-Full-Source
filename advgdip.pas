...
function CalculateDPIScale(AControl: TControl): single; overload;
...
\**************************************************************************)
  ...
  public
    ...
    // MakeFont
    function MakeFont(AFont: TFont): TGPFont; overload;
    function MakeFont(AFont: TFont; ASize: integer): TGPFont; overload;
...
begin
  Result := MakeFont(AFont, AFont.Size);
end;

function TGPGraphics.MakeFont(AFont: TFont; ASize: integer): TGPFont;
var
...
begin
  ...
  Result := TGPFont.Create(fontFamily, ASize , fs, UnitPoint);
