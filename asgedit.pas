...
{ TAsgEditBtn }
  ...
  published
    ...
    property ButtonAlign: TButtonAlign read FButtonAlign write FButtonAlign default btnRight;
...
begin
  ...
  begin
    Loc.Right := ClientWidth - FUnitsize - 3;
    ...
    begin
      Loc.Top := 3;
      Loc.Left := 3 + FButton.Width;
    end
    else
    begin
      Loc.Top := 1;
      Loc.Left := 1 + FButton.Width;
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
      if NewStyleControls and Ctl3D then
        FButton.SetBounds(Dist, 0, FButton.Width, Height - Dist)
      else
        FButton.SetBounds(0, 1, FButton.Width, Height - 3);
    end;
    SetEditRect;
  end;
end;
