...
type
  ...
  protected
    ...
    function AddNewRow(position: integer; hasAction: boolean): TAdvFilterGroupBox;
  ...
  protected
    ...
    procedure DoAppliedFilter(Sender: TObject);
    procedure DoRemovedFilter(Sender: TObject);
    procedure DoRestoredFilter(Sender: TObject);
  public
...
function TAdvCustomFilterPanel.AddNewRow(position: integer; hasAction: boolean): TAdvFilterGroupBox;
var
...
procedure TAdvCustomGridFilterDialog.DoAppliedFilter(Sender: TObject);
begin
  if Assigned(OnAppliedFilter) then
    OnAppliedFilter(Self);
end;
...
procedure TAdvCustomGridFilterDialog.DoRemovedFilter(Sender: TObject);
begin
  if Assigned(OnRemovedFilter) then
    OnRemovedFilter(Self);
end;
...
procedure TAdvCustomGridFilterDialog.DoRestoredFilter(Sender: TObject);
begin
  if Assigned(OnRestoredFilter) then
    OnRestoredFilter(Self);
end;
...
begin
  ...
  FForm.OnAppliedFilter := DoAppliedFilter;
  FForm.OnRestoreFilter := DoRestoreFilter;
  FForm.OnRestoredFilter := DoRestoredFilter;
  FForm.OnRemoveFilter := DoRemoveFilter;
  FForm.OnRemovedFilter := DoRemovedFilter;
...
begin
  ...
  FFilterPanel.OnRestoredFilter := DoRestoredFilter;
  FFilterPanel.OnApplyFilter := DoApplyFilter;
  FFilterPanel.OnAppliedFilter := DoAppliedFilter;
  FFilterPanel.OnRemoveFilter := DoRemoveFilter;
  FFilterPanel.OnRemovedFilter := DoRemovedFilter;
...
procedure TAdvCustomFilterForm.DoAppliedFilter(Sender: TObject);
begin
  if Assigned(OnAppliedFilter) then
    OnAppliedFilter(Self);
end;
...
procedure TAdvCustomFilterForm.DoRemovedFilter(Sender: TObject);
begin
  if Assigned(OnRemovedFilter) then
    OnRemovedFilter(Self);
end;
...
procedure TAdvCustomFilterForm.DoRestoredFilter(Sender: TObject);
begin
  if Assigned(OnRestoredFilter) then
    OnRestoredFilter(Self);
end;
