...
uses
  ...
  Controls, DBAdvGlowNavigator, ExtDlgs, AdvStyleIF, AdvToolButtonStyles
...
begin
  ...
  begin
    style := (Component as TDBAdvGlowNavigator).GetComponentStyle;
    ...
    begin
      ...
      if (Component is TDBAdvGlowNavigator) then
         (Component as TDBAdvGlowNavigator).SetComponentStyle(style);
         Designer.Modified;
    end;
    psf.Free;
  end;
