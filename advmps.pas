...
begin
  ...
  if r.KeyExists('Software\Embarcadero\BDS\20.0\Editor\Highlight') then
    rkey := 'Software\Embarcadero\BDS\20.0\Editor\Highlight\'
  else
  if r.KeyExists('Software\Embarcadero\BDS\19.0\Editor\Highlight') then
    rkey := 'Software\Embarcadero\BDS\19.0\Editor\Highlight\'
  else
