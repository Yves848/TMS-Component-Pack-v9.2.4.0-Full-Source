...
const
  ...
  // v1.1.1.2 : Fixed : High DPI issue with Delphi Tokyo
...
begin
  ...
  begin
    ...
    gpfont := graphics.MakeFont(Canvas.Font);
...
begin
  if Assigned(FBadgeCtrl) and not (csDestroying in FBadgeCtrl.ComponentState) then
  begin
