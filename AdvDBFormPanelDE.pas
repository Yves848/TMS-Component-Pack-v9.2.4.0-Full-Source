...
type
  ...
  TAdvFormPanelSelectionEditor = class(TSelectionEditor)
  public
    procedure RequiresUnits(Proc: TGetStrProc); override;
  end;

  TAdvFormBoxSelectionEditor = class(TSelectionEditor)
  public
    procedure RequiresUnits(Proc: TGetStrProc); override;
  end;
...
{ TAdvFormPanelSelectionEditor }

procedure TAdvFormPanelSelectionEditor.RequiresUnits(Proc: TGetStrProc);
begin
  inherited;
  Proc('AdvDBFormLayouter');
end;

{ TAdvFormBoxSelectionEditor }

procedure TAdvFormBoxSelectionEditor.RequiresUnits(Proc: TGetStrProc);
begin
  inherited;
  Proc('AdvDBFormLayouter');
end;
