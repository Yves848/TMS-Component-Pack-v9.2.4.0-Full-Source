...
const
  ...
  // 6.0.2.3 : Fixed : Issue with ctImage column types
  // 6.0.3.0 : New : Property ReturnIsTab added
  // 6.1.0.0 : New : Delphi 10.3 Rio Support added
  // 6.1.0.1 : Fixed : Rare issue during dropdown initialization
  // 6.1.1.0 : New : When LookupColumn < 0, no lookup is performed
   ...
   if AdvDropDown.Items.Count > 0 then
    ...
    begin
      ...
      begin
        ...
        if Columns[c].ColumnType = ctImage then
          AddImageIdx(c, r + 1, AdvDropDown.Items[r].ImageIndex, haLeft, vaCenter);
      end;
