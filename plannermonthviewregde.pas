...
type
  ...
  TPlannerMonthViewSelectionEditor = class(TSelectionEditor)
  public
...
begin
  ...
  RegisterSelectionEditor(TPlannerMonthView, TPlannerMonthViewSelectionEditor);
end;
...
{ TPlannerMonthViewSelectionEditor }

procedure TPlannerMonthViewSelectionEditor.RequiresUnits(Proc: TGetStrProc);
begin
  inherited;
  Proc('Planner');
end;
