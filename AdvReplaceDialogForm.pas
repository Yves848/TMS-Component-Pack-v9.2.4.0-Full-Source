...
begin
  ...
  if frm.DirGroup.Visible then
    frm.Height := MulDiv(145, DialogUnits.Y, 8)
  else
    frm.Height := MulDiv(114, DialogUnits.Y, 8);
...
procedure TReplaceDialogForm.ComboBox1Exit(Sender: TObject);
var
  s: string;
  buf: array[0..1024] of char;
  hwndEdit: THandle;
...
procedure TReplaceDialogForm.DirGroupClick(Sender: TObject);
begin
