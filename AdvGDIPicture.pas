...
const
  ...
  // v1.4.4.0 : New : OnPaint event added
  // v1.4.5.0 : New : CenterMarginHorz, CenterMarginVert properties added
...
type
  ...
  TPicturePaintEvent = procedure(Sender: TObject; ACanvas: TCanvas; ARect: TRect) of object;
  ...
  private
    ...
    FAngle: Integer;
    FOnPaint: TPicturePaintEvent;
    FColor: TColor;
    FCenterMarginVert: integer;
    FCenterMarginHorz: integer;
    ...
    procedure SetColor(const Value: TColor);
    procedure SetCenterMarginHoz(const Value: integer);
    procedure SetCenterMarginVert(const Value: integer);
  protected
  ...
  public
    ...
    procedure PaintAllTo(ACanvas: TCanvas; DrawRect: TRect);
  ...
  published
    ...
    property CenterMarginHorz: integer read FCenterMarginHorz write SetCenterMarginHoz default 0;
    property CenterMarginVert: integer read FCenterMarginVert write SetCenterMarginVert default 0;
    ...
    property OnPaint: TPicturePaintEvent read FOnPaint write FOnPaint;
...
begin
  PaintAllTo(Canvas, ClientRect);
end;

procedure TAdvGDIPPicture.PaintAllTo(ACanvas: TCanvas; DrawRect: TRect);
var
  h: integer;
  r: TRect;
  s: string;
...
begin
  ...
  drw := DrawRect;
  InflateRect(drw, -FCenterMarginHorz, -FCenterMarginVert);
  ...
  begin
    ...
    begin
      ...
      ACanvas.Pen.Style := BorderPenStyle;
      ACanvas.Pen.Width := 1;
  ...
  begin
    ...
    DrawText(ACanvas.Handle, PChar(EmptyText), Length(EmptyText),r,DT_CENTER or DT_WORDBREAK);
  end;
  ...
  begin
    ...
    begin
      ACanvas.Brush.Color := ButtonClear.Color;
      ACanvas.Pen.Color := ButtonClear.Color;
      ACanvas.FillRect(r);
    end;
    ...
    begin
      ...
      ACanvas.Font.Size := 8;
      ACanvas.Font.Color := ButtonClear.TextColor;

      s := chr($72);
      DrawText(ACanvas.Handle,PChar(s),1,r,DT_CENTER or DT_VCENTER or DT_SINGLELINE);
    end;
  end;
  ...
  begin
    ...
    begin
      ACanvas.Brush.Color := ButtonSelect.Color;
      ACanvas.Pen.Color := ButtonSelect.Color;
      ACanvas.FillRect(r);
    end;
    ...
    begin
      ...
      ACanvas.Font.Size := 8;
      ACanvas.Font.Color := ButtonSelect.TextColor;
...
//        if (h < Height) then
      ...
      r := Rect(x + DrawRect.Left, y + DrawRect.Top, x + w + DrawRect.Left, y + h +DrawRect.Top);
...
procedure TAdvGDIPPicture.SetCenterMarginHoz(const Value: integer);
begin
  if (FCenterMarginHorz <> Value) then
  begin
    FCenterMarginHorz := Value;
    Changed;
  end;
end;

procedure TAdvGDIPPicture.SetCenterMarginVert(const Value: integer);
begin
  if (FCenterMarginVert <> Value) then
  begin
    FCenterMarginVert := Value;
    Changed;
  end;
end;

procedure TAdvGDIPPicture.SetColor(const Value: TColor);
begin
