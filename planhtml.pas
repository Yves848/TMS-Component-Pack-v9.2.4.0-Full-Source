  ...
  repeat
    ...
    begin
      ...
      begin
        ...
        if (length(su)> 0) and (length(su) <= 4) and (e = 0) then
        begin
          res := res + chr(w);
          Delete(s,1,j);
        end;
...
var
  ...
  function HTMLDrawLine(Canvas: TCanvas;var s:string;r: TRect;Calc:Boolean;
                        ...
                        XPos,YPos:Integer;var Hotspot,ImageHotSpot:Boolean; var floatrect: TRect; var txtfloat: TFloatStyle; var NewOffsetX: integer):string;
  var
    su,Res,TagProp,Prop,Tagp,LineText:string;
    cr,ir,tr: TRect;
    linebreak,imgbreak,linkbreak: Boolean;
    th,sw,indent,err,bmpx,bmpy,imgw,imgth,imgh: Integer;
    TagPos,SpacePos,o,l: Integer;
    bmp: TGraphic; //THTMLPicture;
    WordLenEx: Integer;
    ABitmap: TBitmap;
    NewColor: TColor;
    TagWidth,TagHeight,WordLen,WordWidth,txth,imgalign,imgoffs: Integer;
    TagChar: Char;
    LengthFits: Boolean;
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      begin
                        IMGSize.x := Round(FImages.Width * dpiscale);
                        IMGSize.y := Round(FImages.Height * dpiscale);
...
//                    DrawText(Canvas.Handle,'o',1,cr,0);
                  ...
                  begin
                    ...
                    cr.Left := cr.Left + Canvas.TextWidth(OListIndexStr) - LISTINDENT;
                  end;
...
begin
  ...
  dpiscale := GetDeviceCaps(Canvas.Handle,LOGPIXELSX)/96;
  LISTINDENT := Round(12 * dpiscale);
  ...
  begin
    ...
    su := HTMLDrawLine(Canvas,s,r,True,HtmlWidth,HtmlHeight,subh,suph,imgali,Align,PIndent,XPos,YPos,HotSpot,ImageHotSpot, floatrect, txtfloat, newofsx);
    ...
    begin
      ...
      HTMLDrawLine(Canvas,su,dr,CheckHotSpot,HtmlWidth,HtmlHeight,subh,suph,ImgAli,Align,PIndent,XPos,YPos,HotSpot,ImageHotspot,floatrect,txtfloat,newofsx);
