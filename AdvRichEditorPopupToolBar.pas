...
uses
  ...
  AdvRichEditor, AdvToolBarPopup, AdvToolBar, AdvStyleIF;
...
begin
  ...
  FPopupWindow.BkColorSelector.Tools[0].BackGroundColor := RichEditor.Color;
  FPopupWindow.TxtColorSelector.Tools[0].BackGroundColor := RichEditor.Font.Color;
