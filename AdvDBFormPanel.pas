...
const
  ...
  // v1.0.2.1 : Fixed : Issue with persisting layouts
  // v1.0.2.2 : Improved : High DPI handling
...
{$IFDEF DELPHIXE10_LVL}
procedure TAdvDBFormPanel.ChangeScale(M, D: Integer; isDpiChange: boolean);
{$ELSE}
procedure TAdvDBFormPanel.ChangeScale(M, D: Integer);
{$ENDIF}
begin
  inherited;
  Layout.Labels.Font.Height := MulDiv(Layout.Labels.Font.Height, M, D);
end;
