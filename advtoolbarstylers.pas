...
type
  ...
  {$ENDIF}
  TAdvToolBarOfficeStyler = class(TCustomAdvToolBarStyler, ITMSStyleEx, ITMSTones)
  private
  ...
  TAdvToolBarPagerEx = class(TAdvToolBarPager)
...
procedure TAdvToolBarOfficeStyler.SetColorTones(ATones: TColorTones);
begin
  SetComponentStyleAndAppColor(tsOffice2016White, ATones.Foreground.BrushColor);
end;
   ...
   bsOffice2003Classic:
    ...
    bsOffice2013White:
      begin
        ...
        if Assigned(APager) then
        begin
          PageAppearance.Assign(TAdvToolBarPagerEx(APager).PageAppearance);
          TabAppearance.Assign(TAdvToolBarPagerEx(APager).TabAppearance);
          GroupAppearance.Assign(TAdvToolBarPagerEx(APager).GroupAppearance);
          CaptionAppearance.Assign(TAdvToolBarPagerEx(APager).CaptionAppearance);
          GlowButtonAppearance.Assign(TAdvToolBarPagerEx(APager).GlowButtonAppearance);
          PagerCaption.Assign(TAdvToolBarPagerEx(APager).PagerCaption);
          ContainerAppearance.Assign(TAdvToolBarPagerEx(APager).ContainerAppearance);
          Color.Color := PageAppearance.Color;
          Color.ColorTo := clNone;
          Color.Mirror.Color := PageAppearance.Color;;
          Color.Mirror.ColorTo := clNone;
          Color.Mirror.ColorMirror := PageAppearance.Color;
          Color.Mirror.ColorMirrorTo := clNone;
          ColorHot.Color := PageAppearance.Color;;
          ColorHot.ColorTo := clNone;
          ColorHot.Mirror.Color := PageAppearance.Color;;
          ColorHot.Mirror.ColorTo := clNone;
          ColorHot.Mirror.ColorMirror := PageAppearance.Color;;
          ColorHot.Mirror.ColorMirrorTo := clNone;
          CaptionAppearance.CaptionColor :=  PageAppearance.Color;
          CaptionAppearance.CaptionColorTo := clNone;
          CaptionAppearance.CaptionColorHot := PageAppearance.Color;
          CaptionAppearance.CaptionColorHotTo := PageAppearance.Color;
          CaptionAppearance.CaptionTextColor := clBlack;
          CaptionAppearance.CaptionTextColorHot := clBlack;
        end;
    ...
    bsOffice2013Gray:
      begin
        ...
        begin
          ...
          ColorHot.Mirror.ColorMirror := PageAppearance.Color;;
          ColorHot.Mirror.ColorMirrorTo := clNone;
          BorderColor := PageAppearance.Color;
          BorderColorHot := PageAppearance.Color;
          CaptionAppearance.CaptionColor :=  PageAppearance.Color;
          CaptionAppearance.CaptionColorTo := clNone;
          CaptionAppearance.CaptionColorHot := PageAppearance.Color;
          CaptionAppearance.CaptionColorHotTo := PageAppearance.Color;
    ...
    bsOffice2016White:
      begin
        ...
        begin
          ...
          FTones.Tab.Background.TextColor := clWhite;
    ...
    bsOffice2016Gray:
      begin
        ...
        begin
          ...
          FTones.Buttons.Background.TextColor := clWindowText;
        ...
        GlowButtonAppearance.TextColor := clWindowText;
    ...
    bsOffice2016Black:
      begin
        ...
        begin
          ...
          FTones.Buttons.Background.TextColor := $DADADA;
