...
const
  ...
  // v1.0.4.1 : Fixed : Issue with OnAppliedFilter event in dialog
  // v1.0.4.2 : Fixed : Isse with ShowCase and checkbox display
  // v1.0.5.0 : New : Support for working with hiddden columns in grid added 
...
begin
  ...
  begin
    J := grid.RealColIndex(I);
    s := grid.GridCells[J, 0];
    ...
    begin
      sl.AddObject(IntToStr(J), TObject(J));
    end;
  end;
