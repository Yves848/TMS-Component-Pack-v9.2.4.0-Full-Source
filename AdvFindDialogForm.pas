...
type
  ...
  private
    ...
    FOnInternalFindPrevious: TNotifyEvent;
  ...
  protected
    ...
    property OnInternalFindPrevious: TNotifyEvent read FOnInternalFindPrevious write FOnInternalFindPrevious;
  public
...
begin
  ...
  if Assigned(FOnInternalFindPrevious) then
    FOnInternalFindPrevious(Sender);
end;
