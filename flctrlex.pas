...
const
  ...
  // v1.3.0.1 : Fixed : Issue with right-click on empty TFileListBoxEx
  // v1.3.0.2 : Fixed : Issue with right-click in specific areas of TFileListBoxEx
  // v1.3.0.3 : Fixed : Issue with SystemContextMenu setting in TFileListBoxEx
