...
const
  ...
  // 1.1.3.0 : Improved : Text positioning HTML formatted text
...
begin
  ...
  begin
    ...
    begin
      ...
      if DTATTR and DT_VCENTER = DT_VCENTER then
      begin
        HTMLDrawEx(Canvas, Caption, DR, FImageList, -1,-1,-1,-1,2,false,true,false,false,false,false,true,FFormScaled,1.0,clBlue,
          clNone,clNone, clGray, sa, sv, fa, xs, ys, hl, ml, hr, nil, FPictureContainer, 2);

        dr.Top := dr.Top + (dr.Bottom - dr.Top - ys) div 2;
      end;

      HTMLDrawEx(Canvas, Caption, DR, FImageList, -1,-1,-1,-1,2,false,false,false,false,false,false,true,FFormScaled,1.0,clBlue,
        clNone,clNone, clGray, sa, sv, fa, xs, ys, hl, ml, hr, nil, FPictureContainer, 2);
    end
    else
    begin
