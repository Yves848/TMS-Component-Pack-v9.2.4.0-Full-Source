...
uses
  Classes, DBAdvGrd, DB, DesignIntf, DesignEditors, ContNrs, AsgPropPref;
...
begin
  ...
  0:begin
    ...
    MessageDlg(Component.ClassName+' version '+(Component as TDBAdvStringGrid).VersionString+' for '+compiler+#13#10'© 1997-2016 by TMS software',
