...
const
  ...
  // 1.1.0.3 : Fixed : Issue with initialization of ParentCtl3D, Ctl3D
  // 1.1.1.0 : New : WheelEnable property added
  // 1.1.1.1 : Fixed : Regression with transparency
...
type
  ...
  published
    ...
    property WheelEnable: boolean read FWheelEnable write FWheelEnable default false;
...
function TAdvScrollBox.DoMouseWheelDown(Shift: TShiftState;
...
function TAdvScrollBox.DoMouseWheelUp(Shift: TShiftState;
  MousePos: TPoint): Boolean;
begin
  if WheelEnable then
    VertScrollBar.Position := VertScrollBar.Position - 10;
