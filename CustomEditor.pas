...
uses
  ...
  Buttons, DesignIntf, DesignEditors;
...
begin
  ...
  begin
    ...
    begin
      ...
      if Assigned(itorig) and Assigned(itselorig) then
      begin
...
begin
  ...
  AdvPolyList1.DisableReorderAtDesigntime := True;
end;
...
begin
  ...
  begin
    ...
    TCustomItem(OriginalList.Items[FSelectedItemIndex]).Assign(c);
  end;
end;
