...
type
  ...
  public
    ...
    procedure Draw(g: TGPGraphics; Caption: String; x, y, Width, Height, VerticalSpacing,
      ...
      RoundingType: TFillRoundingType; APicture: TAdvGDIPPicture; TextW, TextH: integer; WW: boolean; AImageIndex: Integer; APictureName: String; ATextRendering: TTextRenderingHint = TextRenderingHintSystemDefault);
  ...
  public
    ...
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
    procedure Draw(g: TGPGraphics; x, y, Width, Height: integer; AutoSize: boolean; Caption: String; ADPISCale: single = 1);
    function GetWidth: integer;
    function GetHeight: integer;
    procedure CalculateSize(g: TGPGraphics; Caption: String; ADPIScale: single = 1);
  published
...
procedure TGDIPStatus.CalculateSize(g: TGPGraphics; Caption: String; ADPIScale: single = 1);
var
  ff: TGPFontFamily;
  f: TGPFont;
  fs: integer;
...
begin
  ...
  begin
    ...
    sf := TGPStringFormat.Create;
    f := TGPFont.Create(ff, FFont.Size * ADPIScale, fs, UnitPoint);
...
procedure TGDIPStatus.Draw(g: TGPGraphics; x, y, Width, Height: integer; AutoSize: boolean; Caption: String; ADPISCale: single = 1);
var
  f: TGPFont;
  ff: TGPFontFamily;
  fs: integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      g.SetTextRenderingHint(ATextRendering);
...
begin
  ...
  begin
    ...
    FRounding := (Source as TGDIPDialogButton).Rounding;
    Changed;
  end;
end;
...
begin
  ...
  p := CreateRoundRectangle(r, Rounding, rtBoth, false);
  ...
  p := CreateRoundRectangle(r, Rounding, rttop, false);
  ...
  begin
    p := CreateRoundLine(Bounds(Round(X), Round(Y), Round(Width), Round(Height)), Rounding, rtBoth, BorderWidth);
...
procedure TGDIPDialogButton.SetRounding(const Value: Integer);
begin
  if FRounding <> Value then
  begin
    FRounding := Value;
